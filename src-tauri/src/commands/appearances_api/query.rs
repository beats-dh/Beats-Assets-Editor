...
use super::types::{AppearanceItem, AppearanceCategory, ItemSubcategory, AppearanceDetails, FrameGroupInfo, AppearanceFlagsInfo};
...
pub async fn list_appearances_by_category(
    ...
    let mut filtered_items: Vec<AppearanceItem> = items
        ...
        .filter_map(|appearance| {
            ...
            if category == AppearanceCategory::Objects {
                if let Some(ref filter_subcategory) = subcategory {
                    if *filter_subcategory != ItemSubcategory::All {
                        ...
                        let item_category: Option<i32> = appearance.flags
                            .as_ref()
            ...
            let sprite_count = appearance.frame_group
                .iter()
...
pub async fn get_appearance_details(
    ...
    let frame_groups: Vec<FrameGroupInfo> = appearance.frame_group
        .iter()
