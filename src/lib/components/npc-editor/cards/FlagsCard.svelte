...
<div class="monster-card">
  <div class="monster-card-header">{translate("npc.card.flags.title")}</div>
  <div class="monster-card-body">
    <div class="card-content">
      ...
      >
        <label class="flag-checkbox" for="flgFloorChange">
          <input
            id="flgFloorChange"
            type="checkbox"
            checked={floorchange}
            onchange={(e) =>
              handleFlagChange("floorchange", e.currentTarget.checked)}
          />
          {translate("npc.card.flags.floorChange")}
        </label>
      </div>
    </div>
  </div>
