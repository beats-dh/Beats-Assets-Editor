...
<div class="monster-card">
  <div class="monster-card-header">📋 Informação Básica</div>
  <div class="monster-card-body">
    <div class="card-content">
      ...
      <div class="form-group">
        <label for="npc-desc">Descrição</label>
        <input
          type="text"
          id="npc-desc"
          value={description}
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <input
            ...
            value={health}
            min="1"
            oninput={(e) => handleInput('health', parseInt(e.currentTarget.value) || 1)}
          />
        </div>
        ...
        <div class="form-group">
          ...
          <input
            ...
            value={maxHealth}
            min="1"
            oninput={(e) => handleInput('maxHealth', parseInt(e.currentTarget.value) || 1)}
          />
        </div>
      </div>
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <input
            ...
            value={walkInterval}
            min="0"
            oninput={(e) => handleInput('walkInterval', parseInt(e.currentTarget.value) || 0)}
          />
        </div>
        ...
        <div class="form-group">
          ...
          <input
            ...
            value={walkRadius}
            min="0"
            oninput={(e) => handleInput('walkRadius', parseInt(e.currentTarget.value) || 0)}
          />
        </div>
