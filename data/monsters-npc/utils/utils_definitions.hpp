...
enum MagicEffectClasses : uint16_t {
	...
	CONST_ME_REAPERSTRIKE = 264,

	CONST_ME_HEART_CIRCLE = 265,
	CONST_ME_CANDY_CREAM = 266,
	CONST_ME_PINK_SPARKLES = 268,
	CONST_ME_CANDY_EXPLOSION = 269,
	CONST_ME_CHOCOLATE_EXPLOSION = 270,
	CONST_ME_CANDY_SMOKE = 271,
