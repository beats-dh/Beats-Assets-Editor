...
monster.loot = {
	{ name = "small ruby", chance = 2560, maxCount = 3 },
	{ name = "gold coin", chance = 10000, maxCount = 65 },
	{ name = "gold coin", chance = 10000, maxCount = 60 },
	{ name = "glimmering soil", chance = 2000 },
	{ name = "wand of draconia", chance = 1000 },
}
