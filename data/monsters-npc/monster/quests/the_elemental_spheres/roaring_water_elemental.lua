...
monster.loot = {
	{ name = "small sapphire", chance = 3300, maxCount = 2 },
	{ name = "gold coin", chance = 21600, maxCount = 90 },
	{ name = "gold coin", chance = 21600, maxCount = 87 },
	{ name = "iced soil", chance = 7200 },
	{ name = "northwind rod", chance = 600 },
}
