...
monster.loot = {
	{ name = "gold coin", chance = 30800, maxCount = 120 },
	{ name = "platinum coin", chance = 20300, maxCount = 3 },
	{ name = "holy ash", chance = 7560 },
	{ name = "great spirit potion", chance = 6125, maxCount = 2 },
	{ name = "moonlight rod", chance = 5810 },
	{ name = "spirited soil", chance = 4900 },
	{ name = "holy orchid", chance = 4200 },
}
