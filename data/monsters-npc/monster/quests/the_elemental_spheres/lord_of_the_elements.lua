...
monster.loot = {
	{ name = "small sapphire", chance = 4999, maxCount = 4 },
	{ name = "small ruby", chance = 7778, maxCount = 4 },
	{ name = "small emerald", chance = 7778, maxCount = 4 },
	{ name = "small amethyst", chance = 7778, maxCount = 3 },
	{ name = "platinum coin", chance = 35000, maxCount = 9 },
	{ name = "earthborn titan armor", chance = 1444 },
	{ name = "gold ingot", chance = 17500 },
}
