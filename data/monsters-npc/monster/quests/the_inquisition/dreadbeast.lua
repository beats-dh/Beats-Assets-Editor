...
monster.loot = {
	{ name = "gold coin", chance = 9352, maxCount = 88 },
	{ id = 3115, chance = 6584 }, -- bone
	{ name = "plate armor", chance = 2248 },
	{ id = 3114, chance = 2248 }, -- skull
	{ id = 3116, chance = 1560 }, -- big bone
	{ name = "bone club", chance = 1216 },
	{ name = "bone shield", chance = 1216 },
	{ name = "health potion", chance = 696 },
	{ name = "green mushroom", chance = 520 },
	{ name = "hardened bone", chance = 520 },
}
