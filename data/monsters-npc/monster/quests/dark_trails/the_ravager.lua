...
monster.loot = {
	{ id = 3031, chance = 66500, maxCount = 243 }, -- gold coin
	{ id = 238, chance = 7000, maxCount = 5 }, -- great mana potion
	{ id = 239, chance = 3500, maxCount = 5 }, -- great health potion
	{ id = 3035, chance = 26250, maxCount = 5 }, -- platinum coin
	{ id = 3042, chance = 10500, maxCount = 5 }, -- scarab coin
	{ id = 3328, chance = 3500 }, -- daramian waraxe
}
