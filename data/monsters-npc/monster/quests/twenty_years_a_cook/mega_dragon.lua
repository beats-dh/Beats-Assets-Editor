...
monster.loot = {
	{ name = "Platinum Coin", chance = 40624, minCount = 1, maxCount = 48 },
	{ name = "Nimmersatt's Seal", chance = 6936 },
	{ id = 3039, chance = 8072 },
	{ name = "Molten Dragon Essence", chance = 3776 },
	{ name = "Prismatic Quartz", chance = 3568 },
	{ name = "Rainbow Quartz", chance = 3544, minCount = 1, maxCount = 2 },
	{ id = 3041, chance = 5432 },
	{ name = "Mega Dragon Heart", chance = 1480 },
	{ name = "Violet Gem", chance = 1176 },
	{ name = "Dragon Slayer", chance = 104 },
}
