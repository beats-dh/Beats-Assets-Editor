...
monster.loot = {
	{ name = "Platinum Coin", chance = 42048, minCount = 1, maxCount = 45 },
	{ name = "Wardragon Claw", chance = 11536 },
	{ name = "Nimmersatt's Seal", chance = 8496 },
	{ name = "Dragon Tongue", chance = 6760 },
	{ name = "Wardragon Tooth", chance = 5064 },
	{ name = "Gold Ingot", chance = 4806 },
	{ name = "Onyx Chip", chance = 3720, minCount = 1, maxCount = 2 },
	{ name = "Black Pearl", chance = 3200 },
	{ name = "White Gem", chance = 800 },
	{ name = "Dragonbone Staff", chance = 592 },
}
