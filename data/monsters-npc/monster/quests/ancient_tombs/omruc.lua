...
monster.loot = {
	{ name = "small diamond", chance = 5600, maxCount = 3 },
	...
	{ name = "boots of haste", chance = 1200 },
	{ name = "crystal arrow", chance = 80000 },
	{ name = "arrow", chance = 8000, maxCount = 21 },
	{ name = "poison arrow", chance = 8000, maxCount = 20 },
	{ id = 3449, chance = 8000, maxCount = 15 }, -- burst arrow
	{ name = "power bolt", chance = 8000, maxCount = 3 },
	{ name = "onyx arrow", chance = 8000, maxCount = 2 },
	{ name = "great health potion", chance = 5600 },
}
