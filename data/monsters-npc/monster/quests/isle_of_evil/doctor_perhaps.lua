...
monster.loot = {
	{ id = 3031, chance = 1400, maxCount = 95 }, -- gold coin
	{ id = 3035, chance = 21000, maxCount = 9 }, -- platinum coin
	{ id = 9399, chance = 700 }, -- mighty helm of green sparks
	{ id = 9372, chance = 700 }, -- meat shield
	{ id = 9373, chance = 700 }, -- glutton's mace
	{ id = 9383, chance = 700 }, -- trousers of the ancients
}
