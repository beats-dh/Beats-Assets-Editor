...
monster.loot = {
	...
	{ id = 3035, chance = 70000, maxCount = 20 }, -- platinum coin
	{ id = 16119, chance = 7000, maxCount = 3 }, -- blue crystal shard
	{ id = 238, chance = 7000, maxCount = 5 }, -- great mana potion
	{ id = 7642, chance = 7000, maxCount = 5 }, -- great spirit potion
	{ id = 16121, chance = 7000, maxCount = 3 }, -- green crystal shard
	{ id = 7643, chance = 7000, maxCount = 5 }, -- ultimate health potion
	{ id = 16120, chance = 7000, maxCount = 3 }, -- violet crystal shard
	{ id = 23507, chance = 7000 }, -- crystallized anger
	{ id = 23508, chance = 7000 }, -- energy vein
	{ id = 281, chance = 3500 }, -- giant shimmering pearl (green)
	{ id = 282, chance = 3500 }, -- giant shimmering pearl (brown)
	{ id = 23510, chance = 7000 }, -- odd organ
	{ id = 23520, chance = 7000 }, -- plasmatic lightning
	{ id = 3038, chance = 7000 }, -- green gem
	{ id = 22721, chance = 70000 }, -- gold token
	{ id = 7426, chance = 7000 }, -- amber staff
	{ id = 828, chance = 5600 }, -- lightning headband
	{ id = 23533, chance = 5600 }, -- ring of red plasma
	{ id = 3036, chance = 5600 }, -- violet gem
	{ id = 23474, chance = 4200, unique = true }, -- tiara of power
	{ id = 23477, chance = 4200, unique = true }, -- void boots
	{ id = 23686, chance = 2800, unique = true }, -- devourer core
	{ id = 23684, chance = 1400, unique = true }, -- crackling egg
}
