...
monster.loot = {
	...
	{ id = 5741, chance = 6300 }, -- skull helmet
	{ id = 7420, chance = 2100 }, -- reaper's axe
	{ id = 3061, chance = 8400 }, -- life crystal
	{ id = 5925, chance = 3500, maxCount = 3 }, -- hardened bone
	{ id = 238, chance = 6300, maxCount = 4 }, -- great mana potion
	{ id = 239, chance = 6300, maxCount = 4 }, -- great health potion
	{ id = 6299, chance = 9800 }, -- death ring
	{ id = 3383, chance = 20300 }, -- dark armor
	{ id = 3031, chance = 20300, maxCount = 100 }, -- gold coin
	{ id = 3031, chance = 20300, maxCount = 100 }, -- gold coin
	{ id = 3035, chance = 14000, maxCount = 8 }, -- platinum coin
	{ id = 6499, chance = 4200, maxCount = 4 }, -- demonic essence
	{ id = 6546, chance = 70000 }, -- dracola's eye
}
