...
monster.loot = {
        { name = "crystal coin", chance = 47104 },
        { name = "ultimate health potion", chance = 16824, maxCount = 5 },
        { name = "gold ingot", chance = 13880 },
        { name = "cyan crystal fragment", chance = 5468 },
        { name = "red crystal fragment", chance = 5468 },
        { name = "blue crystal shard", chance = 4202 },
        { name = "small diamond", chance = 3363 },
        { name = "blue gem", chance = 3363 },
        { name = "green crystal fragment", chance = 2524 },
        { name = "magma amulet", chance = 2524 },
        { name = "mercenary sword", chance = 2104 },
        { name = "onyx chip", chance = 2104 },
        { name = "war axe", chance = 2104 },
        { name = "giant sword", chance = 2104 },
        { name = "magma boots", chance = 1685 },
        { name = "stone skin amulet", chance = 419 },
        { name = "bag you desire", chance = 11 },
}
