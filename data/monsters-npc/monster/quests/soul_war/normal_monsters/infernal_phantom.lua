...
monster.loot = {
        { name = "crystal coin", chance = 44568 },
        { name = "terra rod", chance = 24530 },
        { name = "ultimate health potion", chance = 17568, maxCount = 4 },
        { name = "hailstorm rod", chance = 5371 },
        { name = "springsprout rod", chance = 3340 },
        { name = "infernal heart", chance = 3196 },
        { name = "underworld rod", chance = 2757 },
        { name = "fire axe", chance = 2613 },
        { name = "wand of starstorm", chance = 2469 },
        { name = "glorious axe", chance = 2325 },
        { name = "infernal robe", chance = 1886 },
        { name = "chaos mace", chance = 1742 },
        { name = "titan axe", chance = 1454 },
        { name = "wand of voodoo", chance = 1159 },
        { name = "crystal mace", chance = 1159 },
        { name = "war axe", chance = 1015 },
        { name = "warrior's axe", chance = 1015 },
