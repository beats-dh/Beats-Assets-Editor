...
monster.summon = {
	maxSummons = 4,
	summons = {
		{ name = "Retainer of Baeloc", chance = 40, interval = 2000, count = 4 },
	},
}
...
monster.loot = {
	...
	{ name = "piece of draconian steel", minCount = 0, maxCount = 4, chance = 6300 },
	{ id = 3039, minCount = 0, maxCount = 1, chance = 8400 }, -- red gem
	...
	{ name = "skull staff", chance = 6300 },
	{ name = "young lich worm", chance = 4060 },
	{ name = "embrace of nature", chance = 980 },
	{ id = 31592, chance = 1260 }, -- signet ring
	{ name = "terra helmet", chance = 525 },
	{ name = "final judgement", chance = 315 },
