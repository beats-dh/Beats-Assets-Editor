...
monster.loot = {
	...
	{ name = "green gem", minCount = 0, maxCount = 2, chance = 8400 },
	{ name = "silver token", minCount = 0, maxCount = 2, chance = 6650 },
	{ name = "blue gem", chance = 7700 },
	{ name = "crusader helmet", chance = 4480 },
	{ name = "gold ingot", minCount = 0, maxCount = 1, chance = 7000 },
	{ id = 3039, chance = 7700 }, -- red gem
	{ name = "terra hood", chance = 5460 },
	{ name = "yellow gem", chance = 6650 },
	{ name = "young lich worm", chance = 4060 },
	{ name = "bear skin", chance = 1260 },
	{ name = "noble amulet", chance = 770 },
	{ name = "rotten heart", chance = 1190 },
	{ name = "terra helmet", chance = 490 },
	{ name = "final judgement", chance = 322 },
