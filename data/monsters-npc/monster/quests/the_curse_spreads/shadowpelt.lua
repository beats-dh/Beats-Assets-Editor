...
monster.loot = {
	...
	{ name = "opal", chance = 100000, maxCount = 2 },
	{ name = "small enchanted sapphire", chance = 100000, maxCount = 2 },
	{ name = "bear paw", chance = 100000, maxCount = 2 },
	{ name = "furry club", chance = 100000 },
	{ id = 281, chance = 3500 }, -- giant shimmering pearl (green)
	{ name = "great health potion", chance = 100000, maxCount = 5 },
	{ name = "honeycomb", chance = 100000, maxCount = 2 },
	{ name = "spiked squelcher", chance = 100000 },
	{ name = "ultimate health potion", chance = 100000, maxCount = 5 },
	{ name = "werebear fur", chance = 100000, maxCount = 2 },
	{ name = "werebear skull", chance = 100000, maxCount = 2 },
	{ name = "dreaded cleaver", chance = 385 },
	{ name = "fur armor", chance = 385 },
	{ name = "relic sword", chance = 385 },
	{ name = "silver token", chance = 105 },
	{ id = 22103, chance = 105 }, -- werebear trophy
