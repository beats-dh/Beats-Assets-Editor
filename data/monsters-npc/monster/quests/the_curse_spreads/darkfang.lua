...
monster.loot = {
	...
	{ name = "berserk potion", chance = 100000, maxCount = 3 },
	{ name = "black pearl", chance = 100000, maxCount = 3 },
	{ name = "onyx chip", chance = 100000, maxCount = 5 },
	{ name = "small enchanted sapphire", chance = 100000, maxCount = 10 },
	...
	{ name = "troll green", chance = 100000, maxCount = 2 },
	{ name = "werewolf fur", chance = 100000, maxCount = 2 },
	{ name = "wolf paw", chance = 100000, maxCount = 2 },
	{ name = "bonebreaker", chance = 280 },
	{ name = "dreaded cleaver", chance = 280 },
	{ name = "werewolf amulet", chance = 280 },
	{ name = "traditional sai", chance = 175 },
	{ id = 7394, chance = 100000 }, -- wolf trophy
