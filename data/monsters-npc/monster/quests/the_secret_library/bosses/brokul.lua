...
monster.loot = {
	{ name = "small sapphire", chance = 1998, maxCount = 10 },
	{ name = "gold coin", chance = 49000, maxCount = 60 },
	{ name = "platinum coin", chance = 56000, maxCount = 10 },
	{ name = "gold ingot", chance = 2414, maxCount = 10 },
	{ name = "broccoli", chance = 1707, maxCount = 10 },
	{ name = "small diamond", chance = 349, maxCount = 10 },
	{ name = "blue gem", chance = 1750 },
	{ id = 3039, chance = 1400 }, -- red gem
	{ name = "deepling ceremonial dagger", chance = 140 },
	{ name = "deepling fork", chance = 140 },
	{ name = "true book of death", chance = 49000 },
