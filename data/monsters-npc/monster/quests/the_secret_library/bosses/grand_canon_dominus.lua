...
monster.loot = {
	...
	{ name = "great health potion", chance = 70000, maxCount = 3 },
	{ name = "assassin star", chance = 70000, maxCount = 2 },
	{ name = "small amethyst", chance = 70000, maxCount = 2 },
	{ name = "golden armor", chance = 1190 },
	{ name = "mastermind shield", chance = 770 },
	{ name = "patch of fine cloth", chance = 700 },
	{ id = 3039, chance = 1260 }, -- red gem
	{ name = "violet gem", chance = 1295 },
	{ name = "falcon bow", chance = 126 },
	{ name = "falcon wand", chance = 126 },
