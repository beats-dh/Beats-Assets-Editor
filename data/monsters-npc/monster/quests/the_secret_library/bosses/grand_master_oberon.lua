...
monster.loot = {
	{ id = 3115, chance = 21000, maxCount = 1 }, -- bone
	{ name = "brass shield", chance = 21000, maxCount = 1 },
	{ name = "spatial warp almanac", chance = 17500, maxCount = 1 },
	{ name = "viking helmet", chance = 16100, maxCount = 1 },
	{ name = "falcon battleaxe", chance = 350, maxCount = 1 },
	{ name = "falcon longsword", chance = 350, maxCount = 1 },
	{ name = "falcon mace", chance = 350, maxCount = 1 },
	{ name = "grant of arms", chance = 350, maxCount = 1 },
	{ name = "falcon bow", chance = 245, maxCount = 1 },
	{ name = "falcon circlet", chance = 245, maxCount = 1 },
	{ name = "falcon coif", chance = 245, maxCount = 1 },
	{ name = "falcon rod", chance = 245, maxCount = 1 },
	{ name = "falcon wand", chance = 245, maxCount = 1 },
	{ name = "falcon sai", chance = 210, maxCount = 1 },
	{ name = "falcon shield", chance = 140, maxCount = 1 },
	{ name = "falcon greaves", chance = 140, maxCount = 1 },
	{ name = "falcon plate", chance = 140, maxCount = 1 },
