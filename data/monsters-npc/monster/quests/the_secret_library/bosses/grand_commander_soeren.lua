...
monster.loot = {
	{ name = "small enchanted amethyst", chance = 10500, maxCount = 3 },
	{ name = "platinum coin", chance = 35000, maxCount = 3 },
	{ name = "great health potion", chance = 35000, maxCount = 3 },
	{ name = "small ruby", chance = 8890, maxCount = 3 },
	{ name = "onyx arrow", chance = 21000, maxCount = 3 },
	{ name = "golden armor", chance = 700 },
	{ name = "green gem", chance = 910 },
	{ name = "damaged armor plates", chance = 1260, maxCount = 3 },
	{ name = "falcon crest", chance = 280, maxCount = 3 },
	{ name = "patch of fine cloth", chance = 1750 },
	{ name = "falcon coif", chance = 140 },
	{ name = "falcon bow", chance = 140 },
}
