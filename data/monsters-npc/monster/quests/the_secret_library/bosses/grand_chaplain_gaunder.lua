...
monster.loot = {
	{ name = "flask of demonic blood", chance = 35000, maxCount = 2 },
	{ name = "ham", chance = 35000, maxCount = 2 },
	{ name = "onyx arrow", chance = 24500, maxCount = 3 },
	{ name = "small diamond", chance = 21000, maxCount = 3 },
	{ name = "small emerald", chance = 21000, maxCount = 3 },
	{ name = "small enchanted amethyst", chance = 14000, maxCount = 3 },
	{ name = "damaged armor plates", chance = 1645, maxCount = 3 },
	{ id = 281, chance = 8400, maxCount = 1 }, -- giant shimmering pearl (green)
	{ name = "knight armor", chance = 4900 },
	{ name = "patch of fine cloth", chance = 1260 },
	{ name = "spiked squelcher", chance = 2240 },
	{ name = "titan axe", chance = 1680 },
	{ name = "falcon battleaxe", chance = 140 },
	{ name = "falcon longsword", chance = 140 },
	{ name = "falcon mace", chance = 147 },
	{ name = "falcon plate", chance = 70 },
	{ name = "falcon shield", chance = 70 },
}
