...
monster.loot = {
	...
	{ id = 3035, chance = 76528, maxCount = 6 }, -- platinum coin
	{ id = 6499, chance = 16272 }, -- demonic essence
	{ id = 5944, chance = 16104 }, -- soul orb
	{ id = 9054, chance = 11352 }, -- glob of acid slime
	{ id = 9055, chance = 9240 }, -- glob of tar
	{ id = 3034, chance = 4744 }, -- talon
	{ id = 3032, chance = 4320, maxCount = 3 }, -- small emerald
	{ id = 3030, chance = 2200, maxCount = 2 }, -- small ruby
	{ id = 3028, chance = 2120, maxCount = 2 }, -- small diamond
	{ id = 6299, chance = 1952 }, -- death ring
	{ id = 3039, chance = 1272 }, -- red gem
	{ id = 3037, chance = 1104 }, -- yellow gem
	{ id = 3038, chance = 512 }, -- green gem
	{ id = 3041, chance = 256 }, -- blue gem
}
