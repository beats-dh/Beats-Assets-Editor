...
monster.loot = {
	...
	{ id = 16125, chance = 2100, maxCount = 5 }, -- cyan crystal fragment
	{ id = 16126, chance = 2100, maxCount = 5 }, -- red crystal fragment
	{ id = 16127, chance = 2100, maxCount = 5 }, -- green crystal fragment
	{ id = 3026, chance = 2100, maxCount = 8 }, -- white pearl
	{ id = 3029, chance = 2100, maxCount = 9 }, -- small sapphire
	...
	{ id = 3324, chance = 2800 }, -- skull staff
	{ id = 22758, chance = 70, unique = true }, -- death gaze
	{ id = 22866, chance = 490 }, -- rift bow
	{ id = 22867, chance = 490 }, -- rift crossbow
	{ id = 6499, chance = 7700 }, -- demonic essence
	{ id = 7420, chance = 350 }, -- reaper's axe
	{ id = 7426, chance = 2800 }, -- amber staff
	{ id = 238, chance = 2100, maxCount = 5 }, -- great mana potion
	{ id = 239, chance = 2170, maxCount = 5 }, -- great health potion
	{ id = 281, chance = 2100, maxCount = 5 }, -- giant shimmering pearl (green)
	{ id = 282, chance = 2100, maxCount = 5 }, -- giant shimmering pearl (brown)
	{ id = 7642, chance = 2170, maxCount = 5 }, -- great spirit potion
	{ id = 7643, chance = 2100, maxCount = 5 }, -- ultimate health potion
	{ id = 9057, chance = 2100, maxCount = 8 }, -- small topaz
