...
monster.loot = {
	...
	{ id = 16122, chance = 7000, maxCount = 6 }, -- green crystal splinter
	{ id = 16123, chance = 7000, maxCount = 6 }, -- brown crystal splinter
	{ id = 16124, chance = 7000, maxCount = 6 }, -- blue crystal splinter
	...
	{ id = 3098, chance = 4200 }, -- ring of healing
	{ id = 22867, chance = 539 }, -- rift crossbow
	{ id = 8050, chance = 539 }, -- crystalline armor
	{ id = 22726, chance = 469 }, -- rift shield
	{ id = 22762, chance = 350, unique = true }, -- maimer
	{ id = 22555, chance = 350, unique = true }, -- stone wall
