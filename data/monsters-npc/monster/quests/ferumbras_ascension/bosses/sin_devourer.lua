...
monster.loot = {
	{ id = 3740, chance = 3864 }, -- shadow herb
	{ id = 3084, chance = 680 }, -- protection amulet
	{ id = 3055, chance = 96 }, -- platinum amulet
	{ id = 3079, chance = 96 }, -- boots of haste
	{ id = 237, chance = 1280 }, -- strong mana potion
	{ id = 3031, chance = 71872, maxCount = 110 }, -- gold coin
	{ id = 7407, chance = 256 }, -- haunted blade
	{ id = 7427, chance = 96 }, -- chaos mace
	{ id = 9028, chance = 104 }, -- crystal of balance
	{ id = 3007, chance = 824 }, -- crystal ring
	{ id = 8042, chance = 416 }, -- spirit cloak
}
