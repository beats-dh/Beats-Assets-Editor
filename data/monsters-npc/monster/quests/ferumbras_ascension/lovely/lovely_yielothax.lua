...
monster.loot = {
	{ id = 7440, chance = 392 }, -- mastermind potion
	{ id = 12742, chance = 240 }, -- yielowax
	{ id = 12805, chance = 256 }, -- yielocks
	{ id = 3031, chance = 79840, maxCount = 227 }, -- gold coin
	{ id = 3725, chance = 7944, maxCount = 3 }, -- brown mushroom
	{ id = 236, chance = 15928 }, -- strong health potion
	{ id = 237, chance = 15936 }, -- strong mana potion
	{ id = 3028, chance = 3888, maxCount = 5 }, -- small diamond
	{ id = 3034, chance = 760 }, -- talon
	{ id = 3048, chance = 3216 }, -- might ring
	{ id = 12737, chance = 216 }, -- broken ring of ending
	{ id = 3073, chance = 408 }, -- wand of cosmic energy
	{ id = 3326, chance = 416 }, -- epee
	{ id = 9304, chance = 456 }, -- shockwave amulet
	{ id = 816, chance = 664 }, -- lightning pendant
	{ id = 822, chance = 384 }, -- lightning legs
}
