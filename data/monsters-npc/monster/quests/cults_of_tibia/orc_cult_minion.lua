...
monster.loot = {
	...
	{ name = "strong health potion", chance = 12744 },
	{ name = "small topaz", chance = 990, maxCount = 3 },
	{ name = "orcish axe", chance = 7352 },
	{ name = "cultish robe", chance = 15488 },
	{ name = "red mushroom", chance = 5000, maxCount = 3 },
	{ name = "berserk potion", chance = 688, maxCount = 2 },
	{ name = "meat", chance = 3824 },
}
