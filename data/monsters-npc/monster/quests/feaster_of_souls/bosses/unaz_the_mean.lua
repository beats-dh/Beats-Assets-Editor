...
monster.loot = {
	{ name = "platinum coin", chance = 7000, maxCount = 5 },
	{ name = "ivory comb", chance = 700 },
	{ name = "skull coin", chance = 700 },
	{ name = "moonstone", chance = 700, maxCount = 2 },
	{ name = "diamond", chance = 70 },
	{ name = "machete", chance = 280 },
	{ name = "pair of nightmare boots", chance = 140 },
	{ name = "skull staff", chance = 280 },
	{ name = "warrior's axe", chance = 280 },
	{ name = "death toll", chance = 105 },
	{ name = "silver hand mirror", chance = 105 },
	{ id = 3039, chance = 105, maxCount = 2 }, -- red gem
