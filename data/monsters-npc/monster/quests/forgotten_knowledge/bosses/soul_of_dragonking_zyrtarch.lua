...
monster.loot = {
	...
	{ id = 3031, chance = 67900, maxCount = 100 }, -- gold coin
	{ id = 3031, chance = 67900, maxCount = 100 }, -- gold coin
	{ id = 3037, chance = 700 }, -- yellow gem
	{ id = 5882, chance = 3500 }, -- red dragon scale
	{ id = 5889, chance = 350 }, -- piece of draconian steel
	{ id = 9067, chance = 350 }, -- crystal of power
	{ id = 11688, chance = 210 }, -- shield of corruption
	{ id = 9057, chance = 2100, maxCount = 5 }, -- small topaz
	{ id = 3032, chance = 2100, maxCount = 5 }, -- small emerald
	{ id = 9058, chance = 350 }, -- gold ingot
	{ id = 10391, chance = 70 }, -- drachaku
	{ id = 3033, chance = 2100, maxCount = 5 }, -- small amethyst
	{ id = 8021, chance = 350 }, -- modified crossbow
	{ id = 3041, chance = 700 }, -- blue gem
	{ id = 7642, chance = 2100, maxCount = 3 }, -- great spirit potion
	{ id = 3400, chance = 10, unique = true }, -- dragon scale helmet
	{ id = 3039, chance = 700 }, -- red gem
	{ id = 16120, chance = 2100, maxCount = 5 }, -- violet crystal shard
	{ id = 16121, chance = 2100, maxCount = 5 }, -- green crystal shard
	{ id = 5887, chance = 350 }, -- piece of royal steel
	{ id = 238, chance = 2100, maxCount = 3 }, -- great mana potion
	{ id = 3038, chance = 700 }, -- green gem
	{ id = 5948, chance = 3500 }, -- red dragon leather
	{ id = 5904, chance = 350 }, -- magic sulphur
	{ id = 24955, chance = 350, unique = true }, -- part of a rune
	{ id = 16119, chance = 2100, maxCount = 5 }, -- blue crystal shard
	{ id = 281, chance = 350 }, -- giant shimmering pearl (green)
	{ id = 7643, chance = 2100, maxCount = 3 }, -- ultimate health potion
	{ id = 8074, chance = 350 }, -- spellbook of mind control
	{ id = 11692, chance = 210, unique = true }, -- snake god's sceptre
	{ id = 3035, chance = 63000, maxCount = 6 }, -- platinum coin
	{ id = 3030, chance = 2100, maxCount = 5 }, -- small ruby
