...
monster.loot = {
	{ name = "gold coin", chance = 65600, maxCount = 55 },
	{ name = "halberd", chance = 800 },
	{ name = "gear wheel", chance = 3872 },
	{ id = 8894, chance = 160 }, -- heavily rusted armor
	{ name = "slime mould", chance = 248 },
}
