...
monster.loot = {
	...
	{ name = "gold coin", chance = 36000, maxCount = 40 },
	{ id = 3049, chance = 360 }, -- stealth ring
	{ name = "gold ring", chance = 8 },
	{ name = "halberd", chance = 2402 },
	{ name = "golden armor", chance = 8 },
	{ name = "green mushroom", chance = 1160 },
	{ name = "health potion", chance = 3944 },
	{ name = "mana potion", chance = 3960 },
	{ name = "spellbook of enlightenment", chance = 416 },
	{ name = "gear wheel", chance = 752 },
	{ name = "slime mould", chance = 272 },
	{ name = "golden can of oil", chance = 32 },
}
