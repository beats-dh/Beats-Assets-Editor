...
monster.loot = {
	{ id = 3732, chance = 1160 }, -- green mushroom
	{ id = 8775, chance = 752 }, -- gear wheel
	{ id = 3031, chance = 68144, maxCount = 270 }, -- gold coin
	{ id = 266, chance = 3944 }, -- health potion
	{ id = 268, chance = 3960 }, -- mana potion
	{ id = 3269, chance = 2424 }, -- halberd
	{ id = 8072, chance = 416 }, -- spellbook of enlightenment
	{ id = 3049, chance = 360 }, -- stealth ring
	{ id = 12601, chance = 272 }, -- slime mould
	{ id = 12801, chance = 29 }, -- golden can of oil
	{ id = 3360, chance = 10 }, -- golden armor
	{ id = 3063, chance = 6 }, -- gold ring
}
