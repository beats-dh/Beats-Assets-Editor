...
monster.loot = {
	{ name = "gold coin", chance = 74072, maxCount = 128 },
	{ name = "small emerald", chance = 880, maxCount = 2 },
	{ name = "platinum coin", chance = 8600, maxCount = 2 },
	{ name = "daramian mace", chance = 4080 },
	{ name = "steel helmet", chance = 3696 },
	{ name = "black shield", chance = 1456 },
	{ name = "fist on a stick", chance = 176 },
}
