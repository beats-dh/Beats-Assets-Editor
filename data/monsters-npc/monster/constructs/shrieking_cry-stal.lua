...
monster.loot = {
	{ name = "Crystal Coin", chance = 18752, minCount = 1, maxCount = 2 },
	{ name = "Great Spirit Potion", chance = 16608 },
	{ name = "Cry-Stal", chance = 10048, minCount = 1, maxCount = 2 },
	{ name = "Small Diamond", chance = 4816, minCount = 1, maxCount = 3 },
	{ name = "Rusted Armor", chance = 4464 },
	{ name = "Green Crystal Fragment", chance = 3432 },
	{ name = "Terra Boots", chance = 3432 },
	{ name = "Protection Amulet", chance = 1816 },
	{ name = "Violet Gem", chance = 1000 },
	{ name = "Gold Ring", chance = 480 },
	{ name = "Green Gem", chance = 336 },
	{ name = "Ring of the Sky", chance = 168 },
}
