...
monster.loot = {
	{ name = "gold coin", chance = 57600, maxCount = 15 },
	{ name = "gold coin", chance = 57600, maxCount = 15 },
	{ name = "mace", chance = 3024 },
	{ id = 3003, chance = 4152 }, -- rope
	{ name = "bow", chance = 592 },
	{ name = "brass helmet", chance = 1744 },
	{ name = "arrow", chance = 6312, maxCount = 3 },
	{ name = "health potion", chance = 1184 },
	{ id = 3307, chance = 392 }, -- scimitar
}
