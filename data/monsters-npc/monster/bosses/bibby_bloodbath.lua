...
monster.loot = {
	...
	{ name = "orcish axe", chance = 23037 },
	{ name = "two handed sword", chance = 17276 },
	{ name = "throwing star", chance = 13720, maxCount = 18 },
	{ name = "mana potion", chance = 10640, maxCount = 3 },
	{ name = "dark armor", chance = 9800 },
	{ name = "health potion", chance = 8400, maxCount = 3 },
	{ id = 3578, chance = 7210, maxCount = 1 }, -- fish
	{ name = "meat", chance = 7210 },
	{ name = "plate legs", chance = 5670 },
	{ id = 3049, chance = 4872 }, -- stealth ring
	{ name = "magma amulet", chance = 3990 },
	{ name = "giant sword", chance = 2212 },
	{ name = "crusader helmet", chance = 1330 },
	{ name = "butcher's axe", chance = 889 },
	{ id = 7395, chance = 889 }, -- orc trophy
}
