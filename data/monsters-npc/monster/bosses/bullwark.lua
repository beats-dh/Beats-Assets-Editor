...
monster.loot = {
	...
	{ name = "great mana potion", chance = 28000, maxCount = 5 },
	{ name = "great spirit potion", chance = 28000, maxCount = 5 },
	{ name = "ham", chance = 24675, maxCount = 5 },
	{ name = "meat", chance = 24675, maxCount = 5 },
	{ name = "minotaur leather", chance = 18550, maxCount = 2 },
	{ name = "moohtant horn", chance = 14700, maxCount = 2 },
	{ name = "small diamond", chance = 12530, maxCount = 5 },
	{ name = "small emerald", chance = 11445, maxCount = 5 },
	{ name = "small ruby", chance = 10850, maxCount = 5 },
	{ name = "small sapphire", chance = 9940, maxCount = 5 },
	{ name = "giant pacifier", chance = 1344 },
	{ name = "moohtant cudgel", chance = 1260 },
	{ name = "red piece of cloth", chance = 1050 },
	{ name = "yellow gem", chance = 840 },
	{ name = "one hit wonder", chance = 245 },
}
