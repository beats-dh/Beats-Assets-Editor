...
monster.loot = {
	{ name = "gold coin", chance = 70000, maxCount = 80 },
	{ name = "jewelled backpack", chance = 70000 },
	{ name = "strong mana potion", chance = 3500 },
	{ name = "brown mushroom", chance = 3500, maxCount = 3 },
	{ id = 6087, chance = 2100 }, -- music sheet (first verse)
	{ id = 6088, chance = 2100 }, -- music sheet (second verse)
	{ id = 6089, chance = 2100 }, -- music sheet (third verse)
	{ id = 6090, chance = 2100 }, -- music sheet (fourth verse)
}
