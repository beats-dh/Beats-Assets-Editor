...
monster.loot = {
	{ name = "gold coin", chance = 52000, maxCount = 82 },
	{ id = 3059, chance = 3720 }, -- spellbook
	{ name = "two handed sword", chance = 3072 },
	{ name = "morning star", chance = 5560 },
	{ name = "longsword", chance = 7184 },
	{ name = "steel shield", chance = 3201 },
	{ name = "bonelord eye", chance = 752 },
}
