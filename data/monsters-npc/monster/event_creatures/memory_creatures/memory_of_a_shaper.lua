...
monster.loot = {
	{ name = "gold coin", chance = 24000, maxCount = 171 },
	{ name = "vortex bolt", chance = 12000, maxCount = 3 },
	{ name = "gemmed figurine", chance = 5600 },
	{ name = "great health potion", chance = 5600 },
	{ name = "brown mushroom", chance = 5600 },
	{ name = "meat", chance = 9600 },
	{ name = "platinum coin", chance = 17600, maxCount = 2 },
	{ name = "small ruby", chance = 5600, maxCount = 2 },
}
