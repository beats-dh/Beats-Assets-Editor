...
monster.loot = {
	{ name = "gold coin", chance = 80000, maxCount = 121 },
	{ name = "strong health potion", chance = 15064, maxCount = 2 },
	{ name = "onyx chip", chance = 7840 },
	{ id = 3050, chance = 4056 }, -- power ring
	{ name = "small ruby", chance = 5944, maxCount = 2 },
	{ id = 3093, chance = 648 }, -- club ring
	{ name = "small stone", chance = 11112, maxCount = 3 },
	{ id = 37531, chance = 4124 }, -- candy floss
	{ name = "white pearl", chance = 424 },
	{ name = "opal", chance = 4124 },
	{ name = "bonebreaker", chance = 320 },
	{ name = "bottle of champagne", chance = 480 },
}
