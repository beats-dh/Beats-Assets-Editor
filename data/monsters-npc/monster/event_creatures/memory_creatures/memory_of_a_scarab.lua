...
monster.loot = {
	...
	{ name = "gold coin", chance = 40000, maxCount = 155 },
	{ name = "small emerald", chance = 3848, maxCount = 3 },
	{ name = "small amethyst", chance = 4000, maxCount = 4 },
	{ name = "scarab coin", chance = 6154, maxCount = 2 },
	{ id = 3046, chance = 9184 }, -- magic light wand
	{ name = "plate armor", chance = 8240 },
	{ name = "special fx box", chance = 1200 },
	{ name = "strong health potion", chance = 528 },
}
