...
monster.loot = {
	...
	{ name = "small topaz", chance = 5600, maxCount = 2 },
	{ name = "great mana potion", chance = 15064, maxCount = 2 },
	{ name = "bronze gear wheel", chance = 2400 },
	{ name = "small emerald", chance = 5944, maxCount = 2 },
	{ id = 37531, chance = 4124 }, -- candy floss
	{ name = "special fx box", chance = 1200 },
	{ name = "heat core", chance = 4124 },
}
