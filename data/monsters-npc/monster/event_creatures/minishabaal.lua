...
monster.loot = {
	...
	{ id = 3451, chance = 2000 }, -- pitchfork
	{ id = 3320, chance = 466 }, -- fire axe
	{ id = 5944, chance = 636 }, -- soul orb
	{ id = 3420, chance = 140 }, -- demon shield
	{ id = 6499, chance = 700, maxCount = 2 }, -- demonic essence
	{ id = 3364, chance = 126 }, -- golden legs
	{ id = 3031, chance = 70000, maxCount = 20 }, -- gold coin
	{ id = 5944, chance = 636 }, -- soul orb
	{ id = 3382, chance = 560 }, -- crown legs
	{ id = 3415, chance = 933 }, -- guardian shield
	{ id = 3019, chance = 636 }, -- demonbone amulet
	{ id = 3442, chance = 350 }, -- tempest shield
}
