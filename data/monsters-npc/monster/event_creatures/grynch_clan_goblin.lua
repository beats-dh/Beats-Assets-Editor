...
monster.loot = {
	{ id = 2639, chance = 3200 }, -- picture
	{ id = 2950, chance = 4000 }, -- lute
	{ id = 2983, chance = 400 }, -- flower bowl
	{ id = 2992, chance = 5600, maxCount = 5 }, -- snowball
	{ name = "piggy bank", chance = 800 },
	{ name = "gold coin", chance = 18000, maxCount = 22 },
	{ name = "scarab coin", chance = 400, maxCount = 2 },
	{ id = 3047, chance = 3200 }, -- magic light wand
	{ name = "blank rune", chance = 4000 },
	{ id = 3211, chance = 1200 }, -- witchesbroom
	{ id = 3463, chance = 800 }, -- mirror
	{ name = "scarf", chance = 3200 },
	{ name = "red apple", chance = 560, maxCount = 3 },
	{ name = "orange", chance = 5600, maxCount = 3 },
	{ name = "cherry", chance = 5600, maxCount = 4 },
	{ name = "cookie", chance = 5600, maxCount = 5 },
	{ name = "candy cane", chance = 4000, maxCount = 3 },
	{ id = 3606, chance = 4000, maxCount = 2 }, -- egg
	{ name = "explorer brooch", chance = 3200 },
	{ name = "orichalcum pearl", chance = 400, maxCount = 2 },
	{ id = 5792, chance = 800 }, -- die
	{ name = "chicken feather", chance = 3200, maxCount = 5 },
	{ name = "bat wing", chance = 3200, maxCount = 3 },
	{ name = "honeycomb", chance = 3200 },
	{ name = "lump of cake dough", chance = 5600, maxCount = 3 },
	{ name = "valentine's cake", chance = 1200 },
	{ name = "christmas present bag", chance = 5600 },
	{ name = "gingerbreadman", chance = 3200, maxCount = 2 },
	{ name = "walnut", chance = 2800, maxCount = 5 },
	{ name = "peanut", chance = 2800, maxCount = 100 },
}
