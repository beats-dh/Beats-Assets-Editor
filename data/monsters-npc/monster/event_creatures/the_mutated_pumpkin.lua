...
monster.loot = {
	{ name = "pumpkin", chance = 70000 },
	{ name = "yummy gummy worm", chance = 70000, maxCount = 20 },
	{ id = 3599, chance = 700, maxCount = 50 }, -- candy cane
	{ id = 6569, chance = 700, maxCount = 50 }, -- candy
	{ name = "spiderwebs", chance = 700 },
	{ id = 8178, chance = 700 }, -- toy spider
	{ id = 6491, chance = 700 }, -- bat decoration
	{ id = 6525, chance = 700 }, -- skeleton decoration
	{ name = "bar of chocolate", chance = 700 },
	{ id = 6570, chance = 700 }, -- surprise bag
	{ id = 6571, chance = 700 }, -- surprise bag
	{ id = 2977, chance = 700 }, -- pumpkinhead
}
