...
monster.loot = {
	{ name = "gold coin", chance = 73536, maxCount = 95 },
	{ id = 3139, chance = 23352 }, -- wooden trash
	{ name = "red mushroom", chance = 6160 },
	{ name = "health potion", chance = 4104 },
	{ name = "white mushroom", chance = 4024, maxCount = 2 },
	{ name = "haunted piece of wood", chance = 3960 },
	{ name = "orange mushroom", chance = 1440 },
	{ name = "strong health potion", chance = 832 },
	{ id = 3097, chance = 528 }, -- dwarven ring
	{ name = "small emerald", chance = 496 },
	{ name = "bullseye potion", chance = 80 },
}
