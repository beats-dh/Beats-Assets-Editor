...
monster.loot = {
	...
	{ id = 3578, chance = 14560, maxCount = 2 }, -- fish
	{ id = 16124, chance = 1600 }, -- blue crystal splinter
	{ id = 16123, chance = 1600 }, -- brown crystal splinter
	{ id = 16122, chance = 1768 }, -- green crystal splinter
	{ id = 3582, chance = 960 }, -- ham
	{ id = 3723, chance = 1520 }, -- white mushroom
	{ id = 3052, chance = 760 }, -- life ring
	{ id = 3297, chance = 624 }, -- serpent sword
	{ id = 814, chance = 560 }, -- terra amulet
	{ id = 813, chance = 448 }, -- terra boots
	{ id = 3069, chance = 344 }, -- necrotic rod
	{ id = 8072, chance = 256 }, -- spellbook of enlightenment
	{ id = 12311, chance = 80 }, -- carrot on a stick
}
