...
monster.loot = {
	{ name = "gold coin", chance = 69968, maxCount = 27 },
	{ name = "fir cone", chance = 11944 },
	{ name = "dowser", chance = 9752 },
	{ name = "swampling club", chance = 4104 },
	{ name = "white mushroom", chance = 3936, maxCount = 3 },
	{ name = "small emerald", chance = 760 },
}
