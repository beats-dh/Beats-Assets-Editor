...
monster.loot = {
	{ id = 3003, chance = 4064 }, -- rope
	{ name = "gold coin", chance = 67920, maxCount = 12 },
	{ name = "white mushroom", chance = 8176, maxCount = 5 },
	{ name = "swampling club", chance = 5928 },
	{ name = "swampling moss", chance = 15920 },
	{ name = "piece of swampling wood", chance = 11896 },
}
