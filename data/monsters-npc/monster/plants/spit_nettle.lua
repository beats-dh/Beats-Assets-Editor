...
monster.loot = {
	{ name = "gold coin", chance = 8600, maxCount = 5 },
	{ name = "shadow herb", chance = 8864 },
	{ name = "nettle spit", chance = 7696 },
	{ name = "sling herb", chance = 4544, maxCount = 2 },
	{ name = "nettle blossom", chance = 776 },
}
