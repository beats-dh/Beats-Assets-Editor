...
monster.loot = {
	...
	{ name = "mushroom pie", chance = 13704, maxCount = 3 },
	{ name = "brown piece of cloth", chance = 12096 },
	{ name = "drill bolt", chance = 12096, maxCount = 15 },
	{ name = "humongous chunk", chance = 8376 },
	{ name = "white piece of cloth", chance = 8184 },
	{ name = "strong health potion", chance = 4032, maxCount = 2 },
	{ name = "great mana potion", chance = 3968, maxCount = 2 },
	{ name = "great health potion", chance = 3960, maxCount = 2 },
	{ name = "strong mana potion", chance = 3944, maxCount = 2 },
	{ name = "mana potion", chance = 3800, maxCount = 3 },
	{ name = "blue piece of cloth", chance = 3552 },
	{ name = "red piece of cloth", chance = 2136 },
	{ name = "terra amulet", chance = 1744 },
	{ name = "terra boots", chance = 1560 },
	{ name = "angelic axe", chance = 1136 },
	{ name = "terra legs", chance = 928 },
	{ name = "terra mantle", chance = 696 },
	{ name = "muck rod", chance = 512 },
	{ name = "mushroom backpack", chance = 16 },
	{ name = "mycological bow", chance = 112 },
}
