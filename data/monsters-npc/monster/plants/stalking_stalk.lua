...
monster.loot = {
	{ name = "Stalking Seeds", chance = 17216 },
	{ name = "Crystal Coin", chance = 13256, minCount = 1, maxCount = 3 },
	{ name = "Small Diamond", chance = 5712, minCount = 1, maxCount = 3 },
	{ name = "Green Crystal Fragment", chance = 4024 },
	{ name = "Dragon Necklace", chance = 3632 },
	{ name = "Opal", chance = 3168, minCount = 1, maxCount = 2 },
	{ name = "Magma Coat", chance = 1728 },
	{ name = "Bow", chance = 1600 },
	{ name = "Green Gem", chance = 1424 },
	{ name = "Warrior's Axe", chance = 1360 },
	{ name = "Muck Rod", chance = 1048 },
}
