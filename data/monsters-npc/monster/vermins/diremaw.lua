...
monster.loot = {
	{ name = "ham", chance = 32064, maxCount = 4 },
	{ name = "diremaw brainpan", chance = 19296 },
	{ name = "poisonous slime", chance = 9544, maxCount = 5 },
	{ name = "blue crystal shard", chance = 7728 },
	{ name = "violet crystal shard", chance = 6544 },
	{ name = "green crystal shard", chance = 6424 },
	{ name = "onyx chip", chance = 6848, maxCount = 4 },
	{ name = "diremaw legs", chance = 7720, maxCount = 2 },
	{ name = "small enchanted emerald", chance = 2352, maxCount = 2 },
	{ name = "small emerald", chance = 4064, maxCount = 2 },
	{ name = "gold ingot", chance = 2376 },
	{ id = 281, chance = 2480 }, -- giant shimmering pearl (green)
	{ name = "suspicious device", chance = 480 },
	{ name = "mycological bow", chance = 160 },
	{ name = "mushroom backpack", chance = 1200 },
}
