...
monster.loot = {
	{ name = "small ruby", chance = 9520, maxCount = 5 },
	{ name = "gold coin", chance = 40000, maxCount = 100 },
	{ name = "gold coin", chance = 40000, maxCount = 100 },
	{ name = "platinum coin", chance = 36000, maxCount = 4 },
	{ name = "violet gem", chance = 616 },
	{ id = 6299, chance = 2160 }, -- death ring
	{ name = "titan axe", chance = 736 },
	{ name = "great mana potion", chance = 9200, maxCount = 2 },
	{ id = 281, chance = 1360 }, -- giant shimmering pearl (green)
	{ name = "ultimate health potion", chance = 5000, maxCount = 2 },
	{ name = "spidris mandible", chance = 11968 },
	{ name = "compound eye", chance = 10000 },
	{ name = "calopteryx cape", chance = 296 },
	{ name = "carapace shield", chance = 576 },
	{ name = "hive scythe", chance = 552 },
}
