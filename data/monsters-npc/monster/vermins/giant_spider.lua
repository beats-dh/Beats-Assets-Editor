...
monster.loot = {
	{ name = "gold coin", chance = 79992, maxCount = 195 },
	{ id = 3053, chance = 568 }, -- time ring
	{ name = "platinum amulet", chance = 224 },
	{ name = "two handed sword", chance = 4080 },
	{ name = "steel helmet", chance = 3984 },
	{ name = "plate armor", chance = 7984 },
	{ name = "knight armor", chance = 400 },
	{ name = "knight legs", chance = 672 },
	{ name = "poison arrow", chance = 9560, maxCount = 12 },
	{ name = "plate legs", chance = 6666 },
	{ name = "spider silk", chance = 1592 },
	{ name = "strong health potion", chance = 2840 },
	{ name = "lightning headband", chance = 216 },
}
