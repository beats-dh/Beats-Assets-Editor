...
monster.loot = {
	{ name = "scarab amulet", chance = 2728 },
	{ id = 3025, chance = 2000 }, -- ancient amulet
	{ name = "gold coin", chance = 80000, maxCount = 187 },
	{ name = "small emerald", chance = 4800, maxCount = 3 },
	{ name = "small amethyst", chance = 4800, maxCount = 4 },
	{ name = "scarab coin", chance = 6400, maxCount = 2 },
	{ id = 3046, chance = 9184 }, -- magic light wand
	{ name = "daramian waraxe", chance = 240 },
	{ name = "plate armor", chance = 4000 },
	{ name = "scarab shield", chance = 384 },
	{ name = "strong health potion", chance = 1200 },
	{ name = "springsprout rod", chance = 800 },
	{ name = "terra hood", chance = 392 },
	{ name = "scarab pincers", chance = 5600 },
}
