...
monster.loot = {
	...
	{ name = "terra rod", chance = 21224 },
	{ name = "blemished spawn abdomen", chance = 7752, maxCount = 1 },
	{ name = "cyan crystal fragment", chance = 6736, maxCount = 3 },
	{ name = "violet crystal shard", chance = 5904, maxCount = 3 },
	{ name = "hailstorm rod", chance = 4440 },
	{ name = "blue crystal shard", chance = 5040, maxCount = 3 },
	{ name = "knight axe", chance = 3800 },
	{ name = "dragonbone staff", chance = 3160 },
	{ name = "violet gem", chance = 3728 },
	{ name = "yellow gem", chance = 3648 },
	{ name = "wand of starstorm", chance = 3352 },
	{ name = "northwind rod", chance = 4256 },
	{ name = "blemished spawn head", chance = 3872 },
	{ name = "sacred tree amulet", chance = 3200 },
	{ name = "springsprout rod", chance = 3688 },
	{ name = "diamond sceptre", chance = 3160 },
	{ id = 281, chance = 2856 }, -- giant shimmering pearl (green)
	{ name = "ice rapier", chance = 3160 },
	{ id = 3289, chance = 3008 }, -- staff
	{ name = "wand of cosmic energy", chance = 2896 },
	{ name = "blemished spawn tail", chance = 2824 },
