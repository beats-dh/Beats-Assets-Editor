...
monster.loot = {
	{ id = 3007, chance = 1248 }, -- crystal ring
	{ name = "crystal necklace", chance = 1312 },
	{ name = "gold coin", chance = 80000, maxCount = 197 },
	{ id = 3053, chance = 1184 }, -- time ring
	{ name = "platinum amulet", chance = 104 },
	{ name = "steel helmet", chance = 4160 },
	{ id = 7441, chance = 4000 }, -- ice cube
	{ name = "plate armor", chance = 7994 },
	{ name = "knight armor", chance = 448 },
	{ name = "knight legs", chance = 608 },
	{ name = "jewelled backpack", chance = 64 },
	{ name = "spider silk", chance = 1608 },
	{ name = "shard", chance = 592 },
	{ name = "sniper arrow", chance = 4672, maxCount = 6 },
	{ name = "sapphire hammer", chance = 112 },
	{ name = "crystal sword", chance = 1992 },
	{ name = "strong mana potion", chance = 11960 },
	{ name = "glacier mask", chance = 536 },
}
