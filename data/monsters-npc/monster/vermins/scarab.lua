...
monster.loot = {
	{ name = "gold coin", chance = 69440, maxCount = 52 },
	{ name = "small emerald", chance = 330 },
	{ name = "small amethyst", chance = 432 },
	{ name = "scarab coin", chance = 878 },
	{ name = "daramian mace", chance = 196 },
	{ name = "meat", chance = 32000, maxCount = 2 },
	{ name = "piece of scarab shell", chance = 3960 },
}
