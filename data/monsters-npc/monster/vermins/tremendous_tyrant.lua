...
monster.loot = {
	...
	{ name = "gold ingot", chance = 9456, maxCount = 2 },
	{ id = 3039, chance = 11640, maxCount = 1 }, -- red gem
	{ name = "violet crystal shard", chance = 5088, maxCount = 3 },
	{ name = "green crystal shard", chance = 4360 },
	{ name = "blue crystal shard", chance = 4360 },
	{ name = "tremendous tyrant shell", chance = 3640 },
	{ name = "yellow gem", chance = 7272, maxCount = 1 },
	{ name = "spellbook of warding", chance = 6544 },
	{ name = "wand of starstorm", chance = 728 },
	{ name = "ice rapier", chance = 1456 },
	{ name = "hailstorm rod", chance = 2184 },
	{ name = "knight axe", chance = 3640 },
	{ name = "dragonbone staff", chance = 2912 },
	{ name = "tremendous tyrant head", chance = 6544 },
	{ name = "wand of cosmic energy", chance = 2184 },
	{ name = "warrior's shield", chance = 1456 },
	{ name = "elven amulet", chance = 2184 },
	{ name = "focus cape", chance = 1456 },
	{ name = "glacier robe", chance = 3644 },
}
