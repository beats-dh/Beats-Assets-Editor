...
monster.loot = {
	{ name = "gold coin", chance = 71832, maxCount = 100 },
	{ name = "gold coin", chance = 71832, maxCount = 19 },
	{ name = "scarab coin", chance = 5368, maxCount = 4 },
	{ name = "plate armor", chance = 4040 },
	{ name = "spider fangs", chance = 20304 },
	{ name = "gold ingot", chance = 48 },
}
