...
monster.loot = {
	{ name = "gold coin", chance = 63200, maxCount = 40 },
	{ id = 3053, chance = 96 }, -- time ring
	{ name = "steel helmet", chance = 792 },
	{ name = "brass legs", chance = 2440 },
	{ name = "plate shield", chance = 1600 },
	{ name = "spider fangs", chance = 3856 },
	{ name = "tarantula egg", chance = 8000 },
}
