...
monster.loot = {
	{ name = "gold coin", chance = 8000, maxCount = 78 },
	{ name = "wood mushroom", chance = 21760, maxCount = 5 },
	{ name = "chasm spawn head", chance = 26712 },
	{ name = "chasm spawn abdomen", chance = 19768 },
	{ name = "chasm spawn tail", chance = 51912 },
	{ name = "small enchanted emerald", chance = 8832, maxCount = 3 },
	{ name = "small enchanted amethyst", chance = 6536, maxCount = 3 },
	{ name = "brown mushroom", chance = 15744, maxCount = 5 },
	{ name = "orange mushroom", chance = 12112 },
	{ name = "blue crystal shard", chance = 6280 },
	{ name = "green crystal shard", chance = 6280 },
	{ name = "violet crystal shard", chance = 3752 },
	{ name = "mushroom backpack", chance = 488 },
	{ name = "suspicious device", chance = 680 },
}
