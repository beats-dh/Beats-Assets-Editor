...
monster.loot = {
	...
	{ name = "gold coin", chance = 40000, maxCount = 91 },
	{ name = "small amethyst", chance = 2616, maxCount = 3 },
	{ name = "strong mana potion", chance = 13960 },
	{ name = "great mana potion", chance = 4360 },
	{ name = "lightning pendant", chance = 584 },
	{ name = "lightning legs", chance = 120 },
	{ name = "spellbook of warding", chance = 288 },
	{ name = "wand of starstorm", chance = 584 },
	{ id = 8895, chance = 584 }, -- rusted armor
	{ name = "shockwave amulet", chance = 400 },
}
