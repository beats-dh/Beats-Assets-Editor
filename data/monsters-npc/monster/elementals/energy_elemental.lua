...
monster.loot = {
	...
	{ name = "small amethyst", chance = 4000, maxCount = 2 },
	{ id = 3051, chance = 714 }, -- energy ring
	{ name = "silver amulet", chance = 816 },
	{ name = "wand of cosmic energy", chance = 509 },
	{ name = "throwing star", chance = 7920, maxCount = 5 },
	{ name = "obsidian lance", chance = 2857 },
	{ name = "guardian shield", chance = 194 },
	{ name = "crystal sword", chance = 4706 },
	{ name = "strong mana potion", chance = 6154 },
	{ name = "mana potion", chance = 9369 },
	{ id = 761, chance = 8000, maxCount = 10 }, -- flash arrow
}
