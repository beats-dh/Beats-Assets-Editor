...
monster.loot = {
	{ name = "Sulphur Powder", chance = 31552 },
	{ name = "Crystal Coin", chance = 17848, minCount = 1, maxCount = 2 },
	{ name = "Ultimate Mana Potion", chance = 10312, minCount = 1, maxCount = 2 },
	{ name = "Yellow Gem", chance = 2256 },
	{ id = 282, chance = 1960 }, -- Giant Shimmering Pearl (Green)
	{ name = "Slightly Rusted Legs", chance = 1936 },
	{ name = "Knight Legs", chance = 1888 },
	{ id = 3039, chance = 1752 }, -- Red Gem
	{ name = "Warrior's Shield", chance = 1408 },
	{ id = 23533, chance = 888 }, -- Ring of Red Plasma
	{ name = "Fire Sword", chance = 616 },
	{ name = "Crystal Crossbow", chance = 408 },
}
