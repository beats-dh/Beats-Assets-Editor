...
monster.loot = {
	...
	{ name = "small emerald", chance = 2000, maxCount = 2 },
	{ name = "platinum coin", chance = 20000 },
	{ id = 3051, chance = 760 }, -- energy ring
	{ id = 3052, chance = 744 }, -- life ring
	{ id = 3578, chance = 16000 }, -- fish
	{ name = "rainbow trout", chance = 752 },
	{ name = "green perch", chance = 840 },
	{ name = "strong health potion", chance = 8000 },
	{ name = "strong mana potion", chance = 8000 },
}
