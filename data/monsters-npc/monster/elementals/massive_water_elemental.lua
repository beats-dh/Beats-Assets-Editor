...
monster.loot = {
	{ name = "small diamond", chance = 1520, maxCount = 2 },
	{ name = "gold coin", chance = 40000, maxCount = 100 },
	{ name = "small emerald", chance = 800, maxCount = 2 },
	{ name = "platinum coin", chance = 16000, maxCount = 2 },
	{ id = 3051, chance = 728 }, -- energy ring
	{ id = 3052, chance = 800 }, -- life ring
	{ id = 3578, chance = 32000, maxCount = 2 }, -- fish
	{ name = "rainbow trout", chance = 1072 },
	{ name = "green perch", chance = 1272 },
	{ name = "great mana potion", chance = 8320 },
