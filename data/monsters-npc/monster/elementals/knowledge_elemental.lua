...
monster.loot = {
	...
	{ name = "book page", chance = 8000, maxCount = 6 },
	{ name = "small amethyst", chance = 8000, maxCount = 8 },
	{ name = "glowing rune", chance = 8000, maxCount = 3 },
	{ name = "quill", chance = 8000, maxCount = 3 },
	{ name = "silken bookmark", chance = 8000, maxCount = 3 },
	{ name = "flash arrow", chance = 8000, maxCount = 6 },
	{ name = "throwing star", chance = 8000, maxCount = 10 },
	{ name = "crystal sword", chance = 8000 },
	{ id = 3051, chance = 8000 }, -- energy ring
	{ name = "guardian shield", chance = 8000 },
	{ name = "mana potion", chance = 8000, maxCount = 10 },
	{ name = "ultimate mana potion", chance = 8000, maxCount = 8 },
	{ name = "ultimate health potion", chance = 8000, maxCount = 8 },
	{ name = "wand of cosmic energy", chance = 240 },
}
