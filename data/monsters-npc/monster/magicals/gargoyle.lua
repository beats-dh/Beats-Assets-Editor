...
monster.loot = {
	{ id = 3012, chance = 1184 }, -- wolf tooth chain
	{ name = "gold coin", chance = 70400, maxCount = 30 },
	{ id = 3093, chance = 208 }, -- club ring
	{ name = "morning star", chance = 1720 },
	{ name = "steel helmet", chance = 680 },
	{ name = "dark armor", chance = 240 },
	{ name = "battle shield", chance = 800 },
	{ name = "strawberry", chance = 1448, maxCount = 5 },
	{ name = "potato", chance = 7376, maxCount = 2 },
	{ name = "stone wing", chance = 9384 },
	{ name = "shiny stone", chance = 152 },
	{ name = "piece of marble rock", chance = 504 },
}
