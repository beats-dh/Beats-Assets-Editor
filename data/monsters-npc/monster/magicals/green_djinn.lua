...
monster.loot = {
	{ id = 2831, chance = 1824 }, -- book
	{ name = "gold coin", chance = 32800, maxCount = 70 },
	{ name = "gold coin", chance = 40800, maxCount = 45 },
	{ name = "small emerald", chance = 2368, maxCount = 4 },
	{ name = "mystic turban", chance = 112 },
	{ id = 3607, chance = 18800 }, -- cheese
	{ name = "grave flower", chance = 800 },
	{ name = "green piece of cloth", chance = 1600 },
	{ name = "royal spear", chance = 3896, maxCount = 2 },
	{ name = "mana potion", chance = 392 },
	{ name = "dirty turban", chance = 1768 },
}
