...
monster.loot = {
	{ name = "gold coin", chance = 68000, maxCount = 90 },
	{ name = "crystalline arrow", chance = 4000, maxCount = 3 },
	{ name = "green crystal splinter", chance = 3936 },
	{ name = "brown crystal splinter", chance = 4200 },
	{ name = "blue crystal splinter", chance = 4000 },
	{ name = "crystalline spikes", chance = 2952 },
}
