...
monster.loot = {
	{ name = "gold coin", chance = 79432, maxCount = 86 },
	{ name = "elder bonelord tentacle", chance = 16032 },
	{ name = "small flask of eyedrops", chance = 7776 },
	{ name = "sniper arrow", chance = 7024, maxCount = 5 },
	{ name = "two handed sword", chance = 2384 },
	{ name = "steel shield", chance = 1632 },
	{ id = 3059, chance = 824 }, -- spellbook
	{ name = "strong mana potion", chance = 664 },
	{ name = "giant eye", chance = 368 },
	{ name = "bonelord shield", chance = 72 },
	{ name = "bonelord helmet", chance = 72 },
	{ name = "bonelord eye", chance = 1536 },
}
