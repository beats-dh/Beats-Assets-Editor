...
monster.loot = {
	{ name = "gold coin", chance = 79520, maxCount = 48 },
	{ id = 3059, chance = 3992 }, -- spellbook
	{ name = "terra rod", chance = 408 },
	{ name = "two handed sword", chance = 3160 },
	{ name = "morning star", chance = 5616 },
	{ name = "longsword", chance = 7248 },
	{ name = "steel shield", chance = 3184 },
	{ name = "bonelord shield", chance = 88 },
	{ name = "bonelord eye", chance = 800 },
	{ name = "mana potion", chance = 240 },
	{ name = "small flask of eyedrops", chance = 4048 },
}
