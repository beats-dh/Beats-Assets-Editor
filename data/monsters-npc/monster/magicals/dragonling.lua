...
monster.loot = {
	...
	{ name = "gold coin", chance = 30000, maxCount = 100 },
	{ name = "gold coin", chance = 30000, maxCount = 27 },
	{ name = "strong health potion", chance = 19584, maxCount = 2 },
	{ name = "strong mana potion", chance = 13520, maxCount = 2 },
	{ name = "blazing bone", chance = 9928 },
}
