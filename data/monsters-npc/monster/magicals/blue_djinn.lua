...
monster.loot = {
	{ id = 2829, chance = 1880 }, -- book
	{ name = "small oil lamp", chance = 552 },
	{ name = "small sapphire", chance = 2048, maxCount = 4 },
	{ name = "gold coin", chance = 48000, maxCount = 70 },
	{ name = "gold coin", chance = 56000, maxCount = 45 },
	{ name = "mystic turban", chance = 56 },
	{ id = 3595, chance = 18784 }, -- carrot
	{ name = "blue rose", chance = 352 },
	{ name = "blue piece of cloth", chance = 1536 },
	{ name = "royal spear", chance = 3600, maxCount = 2 },
	{ name = "mana potion", chance = 688 },
	{ name = "dirty turban", chance = 1512 },
}
