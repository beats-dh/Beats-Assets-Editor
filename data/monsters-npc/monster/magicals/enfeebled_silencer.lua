...
monster.loot = {
	...
	{ id = 3035, chance = 32000, maxCount = 1 }, -- platinum coin
	{ id = 3049, chance = 960 }, -- stealth ring
	{ id = 3079, chance = 400 }, -- boots of haste
	{ id = 7368, chance = 6080, maxCount = 10 }, -- assassin star
	{ id = 7387, chance = 640 }, -- diamond sceptre
	{ id = 7407, chance = 1280 }, -- haunted blade
	{ id = 7451, chance = 800 }, -- shadow sceptre
	{ id = 7454, chance = 800 }, -- glorious axe
	{ id = 812, chance = 768 }, -- terra legs
	{ id = 813, chance = 384 }, -- terra boots
	{ id = 20200, chance = 3200 }, -- silencer claws
	{ name = "fairy wings", chance = 9600 },
}
