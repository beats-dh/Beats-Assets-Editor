...
monster.loot = {
	...
	{ name = "gold coin", chance = 40000, maxCount = 53 },
	{ name = "platinum coin", chance = 769, maxCount = 3 },
	{ name = "crown helmet", chance = 533 },
	{ name = "meat", chance = 40000, maxCount = 4 },
	{ id = 6299, chance = 200 }, -- death ring
	{ name = "bar of chocolate", chance = 224 },
	{ name = "diamond sceptre", chance = 272 },
	{ name = "shadow sceptre", chance = 216 },
	{ name = "focus cape", chance = 272 },
	{ name = "crystal of focus", chance = 80 },
	{ name = "essence of a bad dream", chance = 6154 },
	{ name = "scythe leg", chance = 3809 },
}
