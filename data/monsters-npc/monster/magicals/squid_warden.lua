...
monster.loot = {
	{ name = "platinum coin", chance = 8800, maxCount = 57 },
	{ name = "glowing rune", chance = 640, maxCount = 4 },
	{ name = "small sapphire", chance = 720, maxCount = 4 },
	{ name = "frosty heart", chance = 8800, maxCount = 4 },
	{ id = 7441, chance = 16000 }, -- ice cube
	{ id = 28568, chance = 16000 }, -- inkwell
	{ name = "ultimate health potion", chance = 8002, maxCount = 4 },
	{ name = "ultimate mana potion", chance = 8002, maxCount = 4 },
	{ name = "ice rapier", chance = 400 },
	{ name = "glacier mask", chance = 320 },
	{ name = "piece of dead brain", chance = 8001, maxCount = 4 },
	{ name = "crystal sword", chance = 240 },
	{ name = "glacier robe", chance = 120 },
	{ name = "glacier kilt", chance = 120 },
	{ name = "slime heart", chance = 8002, maxCount = 4 },
}
