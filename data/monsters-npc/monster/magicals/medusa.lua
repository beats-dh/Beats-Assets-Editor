...
monster.loot = {
	...
	{ name = "small emerald", chance = 3016, maxCount = 4 },
	{ name = "platinum coin", chance = 59848, maxCount = 6 },
	{ name = "knight armor", chance = 1472 },
	{ name = "medusa shield", chance = 2432 },
	{ name = "titan axe", chance = 928 },
	{ name = "great mana potion", chance = 8000, maxCount = 2 },
	{ name = "terra mantle", chance = 696 },
	{ name = "terra legs", chance = 336 },
	{ name = "terra amulet", chance = 3248 },
	{ name = "ultimate health potion", chance = 7432, maxCount = 2 },
	{ id = 8896, chance = 400 }, -- slightly rusted armor
	{ name = "sacred tree amulet", chance = 680 },
	{ name = "strand of medusa hair", chance = 7920 },
}
