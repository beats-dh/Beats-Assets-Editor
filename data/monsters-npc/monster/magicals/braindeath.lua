...
monster.loot = {
	{ name = "gold coin", chance = 79576, maxCount = 89 },
	{ name = "bone sword", chance = 12104 },
	{ name = "sniper arrow", chance = 7648, maxCount = 4 },
	{ name = "steel shield", chance = 4752 },
	{ name = "piece of dead brain", chance = 4024 },
	{ name = "bonelord eye", chance = 2368 },
	{ name = "clerical mace", chance = 1576 },
	{ name = "haunted blade", chance = 1152 },
	{ id = 3059, chance = 744 }, -- spellbook
	{ name = "spiked squelcher", chance = 144 },
	{ name = "bonelord shield", chance = 80 },
	{ name = "bonelord helmet", chance = 80 },
}
