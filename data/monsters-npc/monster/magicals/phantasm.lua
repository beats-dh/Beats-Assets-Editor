...
monster.loot = {
	{ name = "small ruby", chance = 9728, maxCount = 3 },
	{ name = "gold coin", chance = 24000, maxCount = 100 },
	{ name = "gold coin", chance = 24000, maxCount = 100 },
	{ name = "gold coin", chance = 22400, maxCount = 33 },
	{ name = "small emerald", chance = 8152, maxCount = 3 },
	{ name = "small amethyst", chance = 11656, maxCount = 3 },
	{ name = "platinum coin", chance = 70184, maxCount = 4 },
	{ id = 3049, chance = 440 }, -- stealth ring
	{ name = "blank rune", chance = 18000, maxCount = 2 },
	{ name = "crown armor", chance = 528 },
	{ name = "shadow herb", chance = 21544, maxCount = 2 },
	{ id = 6299, chance = 264 }, -- death ring
	{ name = "demonic essence", chance = 13056 },
	{ name = "abyss hammer", chance = 88 },
	{ name = "shadow sceptre", chance = 440 },
	{ name = "great mana potion", chance = 26200, maxCount = 2 },
	{ name = "ultimate health potion", chance = 11744 },
	{ name = "small topaz", chance = 10248, maxCount = 3 },
}
