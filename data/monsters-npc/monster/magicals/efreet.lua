...
monster.loot = {
	{ id = 2647, chance = 1760 }, -- green tapestry
	{ name = "small oil lamp", chance = 128 },
	{ name = "gold coin", chance = 40000, maxCount = 75 },
	{ name = "gold coin", chance = 48000, maxCount = 50 },
	{ name = "small emerald", chance = 5600 },
	{ name = "green gem", chance = 160 },
	{ name = "wand of inferno", chance = 312 },
	{ name = "heavy machete", chance = 4000 },
	{ name = "mystic turban", chance = 128 },
	{ name = "pear", chance = 7512, maxCount = 5 },
	{ name = "green piece of cloth", chance = 2400 },
	{ name = "royal spear", chance = 12456, maxCount = 3 },
	{ name = "strong mana potion", chance = 2800 },
	{ name = "magma monocle", chance = 288 },
	{ name = "jewelled belt", chance = 6832 },
	{ name = "noble turban", chance = 904 },
}
