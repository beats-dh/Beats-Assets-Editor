...
monster.loot = {
	{ name = "small sapphire", chance = 568 },
	{ name = "gold coin", chance = 40000, maxCount = 35 },
	{ id = 3046, chance = 11200 }, -- magic light wand
	{ id = 3059, chance = 288 }, -- spellbook
	{ id = 3097, chance = 424 }, -- dwarven ring
	{ name = "blank rune", chance = 26400 },
	{ name = "clerical mace", chance = 896 },
	{ name = "pear", chance = 20000 },
	{ name = "white mushroom", chance = 48000, maxCount = 2 },
	{ name = "iron ore", chance = 96 },
	{ name = "terra boots", chance = 376 },
	{ name = "geomancer's robe", chance = 6400 },
	{ name = "geomancer's staff", chance = 5600 },
}
