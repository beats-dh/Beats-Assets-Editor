...
monster.loot = {
	{ id = 3147, chance = 10880, maxCount = 2 }, -- blank rune
	{ id = 3031, chance = 79600, maxCount = 199 }, -- gold coin
	{ id = 3347, chance = 11904, maxCount = 5 }, -- hunting spear
	{ id = 3035, chance = 27112, maxCount = 3 }, -- platinum coin
	{ id = 7378, chance = 9128, maxCount = 5 }, -- royal spear
	{ id = 236, chance = 8280, maxCount = 2 }, -- strong health potion
	{ id = 237, chance = 8496, maxCount = 2 }, -- strong mana potion
	{ id = 5944, chance = 5944 }, -- soul orb
	{ id = 5878, chance = 4024 }, -- minotaur leather
	{ id = 11472, chance = 3776, maxCount = 2 }, -- minotaur horn
	{ id = 3030, chance = 2112, maxCount = 3 }, -- small ruby
	{ id = 3033, chance = 2064, maxCount = 3 }, -- small amethyst
	{ id = 3049, chance = 1776 }, -- stealth ring
	{ id = 5912, chance = 1336 }, -- blue piece of cloth
	{ id = 5910, chance = 1136 }, -- green piece of cloth
	{ id = 5911, chance = 1088 }, -- red piece of cloth
	{ id = 21175, chance = 512 }, -- mino shield
	{ id = 3037, chance = 376 }, -- yellow gem
	{ id = 3039, chance = 320 }, -- red gem
	{ id = 7401, chance = 152 }, -- minotaur trophy
	{ id = 21166, chance = 136 }, -- mooh'tah plate
}
