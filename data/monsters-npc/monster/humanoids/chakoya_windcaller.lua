...
monster.loot = {
	{ name = "gold coin", chance = 56936, maxCount = 27 },
	{ name = "brass helmet", chance = 3512 },
	{ name = "bone shield", chance = 768 },
	{ id = 3578, chance = 24632, maxCount = 3 }, -- fish
	{ name = "northern pike", chance = 32 },
	{ name = "rainbow trout", chance = 32 },
	{ name = "green perch", chance = 88 },
	{ name = "fireproof horn", chance = 328 },
}
