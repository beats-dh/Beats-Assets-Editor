...
monster.loot = {
	{ name = "gold coin", chance = 35200, maxCount = 30 },
	{ name = "longsword", chance = 8640 },
	{ name = "studded helmet", chance = 10800 },
	{ name = "studded armor", chance = 7168 },
	{ name = "plate shield", chance = 7440 },
	{ name = "arrow", chance = 5648, maxCount = 3 },
	{ name = "leather boots", chance = 9128 },
	{ id = 5921, chance = 752 }, -- heaven blossom
	{ name = "plum", chance = 16000, maxCount = 2 },
	{ name = "elvish talisman", chance = 1680 },
}
