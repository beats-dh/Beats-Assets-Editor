...
monster.loot = {
	{ id = 2824, chance = 416 }, -- book
	{ name = "gold coin", chance = 72000, maxCount = 5 },
	{ name = "wand of decay", chance = 800 },
	{ name = "spear", chance = 3880 },
	{ name = "chain armor", chance = 7000 },
	{ name = "corncob", chance = 8480, maxCount = 2 },
	{ name = "orc tooth", chance = 1680 },
	{ name = "broken shamanic staff", chance = 8240 },
	{ name = "shamanic hood", chance = 5488 },
	{ name = "orc leather", chance = 3440 },
