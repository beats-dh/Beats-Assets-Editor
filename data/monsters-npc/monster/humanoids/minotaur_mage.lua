...
monster.loot = {
	{ id = 2920, chance = 3960 }, -- torch
	{ name = "gold coin", chance = 68624, maxCount = 35 },
	{ name = "wand of cosmic energy", chance = 480 },
	{ name = "leather helmet", chance = 2400 },
	{ name = "leather legs", chance = 4152 },
	{ id = 3595, chance = 12002, maxCount = 8 }, -- carrot
	{ name = "minotaur leather", chance = 1832 },
	{ name = "taurus mace", chance = 800 },
	{ name = "mana potion", chance = 392 },
	{ name = "minotaur horn", chance = 2416, maxCount = 2 },
	{ name = "purple robe", chance = 5144, maxCount = 2 },
}
