...
monster.loot = {
	{ name = "waterskin", chance = 1080 },
	{ name = "gold coin", chance = 60000, maxCount = 25 },
	{ name = "bow", chance = 3200 },
	{ name = "arrow", chance = 24568, maxCount = 12 },
	{ name = "poison arrow", chance = 12320, maxCount = 4 },
	{ name = "sandals", chance = 944 },
	{ name = "grapes", chance = 14200 },
	{ id = 5921, chance = 904 }, -- heaven blossom
	{ name = "elvish bow", chance = 112 },
	{ name = "elvish talisman", chance = 4160 },
	{ name = "elven scouting glass", chance = 7800 },
}
