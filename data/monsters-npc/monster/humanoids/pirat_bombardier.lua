...
monster.loot = {
	{ name = "great mana potion", chance = 24000, maxCount = 2 },
	{ name = "pirate coin", chance = 5600, maxCount = 10 },
	{ name = "terra boots", chance = 4800 },
	{ name = "pirat's tail", chance = 3200 },
	{ name = "magma boots", chance = 2400 },
	{ name = "mouldy powder", chance = 3200 },
	{ id = 23529, chance = 1600 }, -- ring of blue plasma
	{ name = "lightning boots", chance = 800 },
	{ name = "wood cape", chance = 800 },
}
