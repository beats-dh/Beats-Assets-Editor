...
monster.loot = {
	{ id = 2920, chance = 3800 }, -- torch
	{ name = "gold coin", chance = 55200, maxCount = 13 },
	{ id = 3114, chance = 2640, maxCount = 3 }, -- skull
	{ name = "poison dagger", chance = 1800 },
	{ name = "bone shield", chance = 800 },
	{ name = "cleaver", chance = 7800 },
	{ name = "ripper lance", chance = 72 },
	{ name = "hunting spear", chance = 1600 },
