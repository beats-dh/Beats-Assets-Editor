...
monster.loot = {
	{ name = "gold coin", chance = 47712, maxCount = 20 },
	{ name = "double axe", chance = 320 },
	{ name = "chain armor", chance = 2384 },
	{ name = "brass armor", chance = 3512 },
	{ name = "battle shield", chance = 1720 },
	{ name = "fishing rod", chance = 384 },
	{ name = "minotaur leather", chance = 800 },
	{ id = 7401, chance = 64 }, -- minotaur trophy
	{ name = "health potion", chance = 320 },
	{ name = "minotaur horn", chance = 6664, maxCount = 2 },
	{ name = "piece of warrior armor", chance = 4032 },
}
