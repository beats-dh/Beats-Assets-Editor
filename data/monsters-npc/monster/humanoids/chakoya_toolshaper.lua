...
monster.loot = {
	{ name = "gold coin", chance = 62248, maxCount = 20 },
	{ name = "mace", chance = 4240 },
	{ name = "bone shield", chance = 576 },
	{ id = 3456, chance = 880 }, -- pick
	{ id = 3578, chance = 20048, maxCount = 2 }, -- fish
	{ name = "northern pike", chance = 56 },
	{ name = "rainbow trout", chance = 112 },
	{ name = "green perch", chance = 56 },
	{ name = "mammoth whopper", chance = 128 },
	{ id = 7441, chance = 360 }, -- ice cube
	{ name = "fireproof horn", chance = 312 },
}
