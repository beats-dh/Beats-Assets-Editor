...
monster.loot = {
	{ name = "platinum coin", chance = 57912, maxCount = 12 },
	{ name = "ultimate health potion", chance = 9496 },
	{ name = "miraculum", chance = 7704 },
	{ name = "dream essence egg", chance = 7848 },
	{ id = 8093, chance = 4256, maxCount = 2 }, -- wand of draconia
	{ name = "holy orchid", chance = 2776 },
	{ name = "magma amulet", chance = 2320 },
	{ name = "wand of inferno", chance = 3488 },
	{ name = "fire axe", chance = 2088 },
	{ name = "magma coat", chance = 1824 },
	{ name = "wand of dragonbreath", chance = 2120 },
	{ name = "sun fruit", chance = 1712, maxCount = 2 },
	{ name = "magma legs", chance = 520 },
	{ name = "magma monocle", chance = 376 },
}
