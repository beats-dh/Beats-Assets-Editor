...
monster.loot = {
	{ name = "gold coin", chance = 63672, maxCount = 20 },
	{ name = "short sword", chance = 3848 },
	{ name = "bone shield", chance = 824 },
	{ id = 3578, chance = 15496 }, -- fish
	{ name = "northern pike", chance = 48 },
	{ name = "rainbow trout", chance = 40 },
	{ name = "green perch", chance = 80 },
	{ name = "mammoth whopper", chance = 104 },
	{ name = "fireproof horn", chance = 280 },
}
