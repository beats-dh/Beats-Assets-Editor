...
monster.loot = {
	{ name = "gold coin", chance = 60328, maxCount = 30 },
	{ name = "crossbow", chance = 664 },
	{ name = "brass armor", chance = 424 },
	{ name = "scale armor", chance = 424 },
	{ name = "bolt", chance = 72360, maxCount = 20 },
	{ name = "meat", chance = 4000 },
	{ name = "minotaur leather", chance = 1520 },
	{ name = "piercing bolt", chance = 9872, maxCount = 4 },
	{ name = "broken crossbow", chance = 12320 },
	{ name = "minotaur horn", chance = 1592, maxCount = 2 },
	{ name = "piece of archer armor", chance = 6608 },
}
