...
monster.loot = {
	{ id = 2920, chance = 4800 }, -- torch
	{ name = "gold coin", chance = 60000, maxCount = 13 },
	{ name = "bronze amulet", chance = 88 },
	{ id = 3114, chance = 800, maxCount = 2 }, -- skull
	{ name = "poison dagger", chance = 1200 },
	{ name = "leather armor", chance = 8000 },
	{ name = "poison arrow", chance = 4000, maxCount = 3 },
	{ name = "tribal mask", chance = 408 },
	{ name = "bast skirt", chance = 80 },
	{ name = "seeds", chance = 160 },
}
