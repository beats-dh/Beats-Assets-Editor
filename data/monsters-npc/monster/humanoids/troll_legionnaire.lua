...
monster.loot = {
	{ name = "gold coin", chance = 73600, maxCount = 155 },
	{ id = 3049, chance = 448 }, -- stealth ring
	{ name = "throwing star", chance = 22400, maxCount = 10 },
	{ name = "frosty ear of a troll", chance = 4096 },
}
