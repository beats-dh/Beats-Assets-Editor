...
monster.loot = {
	...
	{ id = 3035, chance = 46528, maxCount = 2 }, -- platinum coin
	{ id = 21200, chance = 2192, maxCount = 2 }, -- moohtant horn
	{ id = 21199, chance = 1416 }, -- giant pacifier
	{ id = 239, chance = 5904, maxCount = 3 }, -- great health potion
	{ id = 238, chance = 5784, maxCount = 3 }, -- great mana potion
	{ id = 3577, chance = 5216 }, -- meat
	{ id = 3030, chance = 3744, maxCount = 2 }, -- small ruby
	{ id = 5878, chance = 3288 }, -- minotaur leather
	{ id = 3028, chance = 3520, maxCount = 2 }, -- small diamond
	{ id = 3098, chance = 1928 }, -- ring of healing
	{ id = 5911, chance = 720 }, -- red piece of cloth
	{ id = 21173, chance = 688 }, -- moohtant cudgel
	{ id = 3037, chance = 568 }, -- yellow gem
	{ id = 7452, chance = 344 }, -- spiked squelcher
	{ id = 7427, chance = 224 }, -- chaos mace
	{ id = 9058, chance = 224 }, -- gold ingot
	{ id = 7401, chance = 224 }, -- minotaur trophy
}
