...
monster.loot = {
	...
	{ name = "gold coin", chance = 60000, maxCount = 17 },
	{ name = "strange symbol", chance = 400 },
	{ id = 3114, chance = 1560, maxCount = 3 }, -- skull
	{ id = 3115, chance = 4640 }, -- bone
	{ id = 3116, chance = 2400 }, -- big bone
	{ name = "poison dagger", chance = 800 },
	{ name = "leather armor", chance = 8000 },
	{ id = 3002, chance = 104 }, -- voodoo doll
