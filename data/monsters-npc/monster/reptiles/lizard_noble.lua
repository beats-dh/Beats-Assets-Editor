...
monster.loot = {
	{ name = "small ruby", chance = 5680, maxCount = 5 },
	{ name = "gold coin", chance = 73040, maxCount = 100 },
	{ name = "platinum coin", chance = 8000, maxCount = 20 },
	{ name = "lizard leather", chance = 176 },
	{ name = "lizard scale", chance = 520 },
	{ name = "strong health potion", chance = 2040 },
	{ name = "great health potion", chance = 2320 },
}
