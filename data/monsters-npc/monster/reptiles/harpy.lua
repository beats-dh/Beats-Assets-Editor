...
monster.loot = {
	{ name = "platinum coin", chance = 58504, maxCount = 25 },
	{ name = "harpy feathers", chance = 5376 },
	{ name = "violet crystal shard", chance = 3752 },
	{ name = "blue crystal shard", chance = 3624 },
	{ name = "great spirit potion", chance = 2376, maxCount = 3 },
	{ name = "gold ring", chance = 1376 },
	{ name = "wand of defiance", chance = 1376 },
	{ name = "focus cape", chance = 1248 },
	{ name = "violet gem", chance = 960 },
	{ name = "ornate crossbow", chance = 400 },
	{ name = "shockwave amulet", chance = 376 },
	{ name = "magic plate armor", chance = 352 },
}
