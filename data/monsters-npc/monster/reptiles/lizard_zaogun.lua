...
monster.loot = {
	{ name = "gold coin", chance = 25200, maxCount = 100 },
	{ name = "gold coin", chance = 25200, maxCount = 100 },
	{ name = "gold coin", chance = 24800, maxCount = 68 },
	{ name = "small emerald", chance = 3864, maxCount = 5 },
	{ name = "platinum coin", chance = 39120, maxCount = 2 },
	{ name = "tower shield", chance = 800 },
	{ name = "lizard leather", chance = 11488 },
	{ name = "lizard scale", chance = 10016 },
	{ name = "strong health potion", chance = 1520 },
	{ name = "great health potion", chance = 5600, maxCount = 3 },
	{ name = "red lantern", chance = 1736 },
	{ name = "zaoan armor", chance = 424 },
	{ name = "zaoan shoes", chance = 800 },
	{ name = "zaoan legs", chance = 801 },
	{ name = "zaogun flag", chance = 6624 },
	{ name = "zaogun shoulderplates", chance = 11984 },
}
