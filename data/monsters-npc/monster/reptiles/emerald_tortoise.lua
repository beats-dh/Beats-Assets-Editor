...
monster.loot = {
	{ name = "Emerald Tortoise Shell", chance = 22872 },
	{ name = "Crystal Coin", chance = 12416, minCount = 1, maxCount = 3 },
	{ name = "Great Spirit Potion", chance = 10688, minCount = 1, maxCount = 2 },
	{ name = "Blue Crystal Shard", chance = 3224 },
	{ name = "Green Crystal Fragment", chance = 3160 },
	{ name = "Violet Gem", chance = 3160 },
	{ name = "Red Crystal Fragment", chance = 2680 },
	{ name = "Yellow Gem", chance = 2656 },
	{ name = "White Pearl", chance = 2592 },
	{ name = "Green Crystal Shard", chance = 2320 },
	{ name = "Green Gem", chance = 2296 },
	{ name = "Orichalcum Pearl", chance = 2112, minCount = 1, maxCount = 2 },
	{ id = 282, chance = 1936 }, -- Giant Shimmering Pearl (Green)
	{ id = 3039, chance = 1936 }, -- Red Gem
	{ name = "Black Pearl", chance = 1728, minCount = 1, maxCount = 2 },
}
