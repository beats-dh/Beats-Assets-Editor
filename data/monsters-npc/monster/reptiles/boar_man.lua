...
monster.loot = {
	{ name = "platinum coin", chance = 63160, maxCount = 22 },
	{ name = "red crystal fragment", chance = 7864, maxCount = 6 },
	{ id = 3039, chance = 5112, maxCount = 2 }, -- red gem
	{ name = "boar man hoof", chance = 3712, maxCount = 2 },
	{ name = "great health potion", chance = 3048, maxCount = 4 },
	{ name = "sapphire hammer", chance = 2160 },
	{ name = "crystal mace", chance = 1728 },
	{ name = "crystal sword", chance = 1048 },
	{ name = "tower shield", chance = 744 },
	{ id = 3007, chance = 568 }, -- crystal ring
}
