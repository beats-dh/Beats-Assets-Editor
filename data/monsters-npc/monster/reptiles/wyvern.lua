...
monster.loot = {
	{ name = "emerald bangle", chance = 432 },
	{ name = "small sapphire", chance = 4000 },
	{ name = "gold coin", chance = 80000, maxCount = 90 },
	{ name = "wand of inferno", chance = 648 },
	{ name = "power bolt", chance = 2720, maxCount = 2 },
	{ name = "dragon ham", chance = 48400, maxCount = 3 },
	{ name = "wyvern fang", chance = 328 },
	{ name = "strong health potion", chance = 2000 },
	{ name = "wyvern talisman", chance = 9840 },
}
