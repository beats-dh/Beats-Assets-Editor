...
monster.loot = {
	{ name = "small diamond", chance = 152 },
	{ name = "gold coin", chance = 71200, maxCount = 80 },
	{ name = "halberd", chance = 408 },
	{ name = "spear", chance = 7000, maxCount = 3 },
	{ name = "obsidian lance", chance = 896 },
	{ name = "chain armor", chance = 6848 },
	{ name = "scale armor", chance = 6184 },
	{ name = "hunting spear", chance = 3760 },
	{ name = "sentinel shield", chance = 256 },
	{ name = "lizard leather", chance = 792 },
	{ name = "lizard scale", chance = 768 },
	{ name = "health potion", chance = 472 },
}
