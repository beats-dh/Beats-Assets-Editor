...
monster.loot = {
	{ name = "small diamond", chance = 2040, maxCount = 5 },
	{ name = "gold coin", chance = 26400, maxCount = 100 },
	{ name = "gold coin", chance = 25600, maxCount = 100 },
	{ name = "gold coin", chance = 25600, maxCount = 36 },
	{ name = "platinum coin", chance = 2336, maxCount = 5 },
	{ name = "tower shield", chance = 880 },
	{ name = "lizard leather", chance = 1600 },
	{ name = "lizard scale", chance = 784, maxCount = 3 },
	{ name = "great health potion", chance = 4280, maxCount = 3 },
	{ name = "zaoan armor", chance = 784 },
	{ name = "zaoan helmet", chance = 112 },
	{ name = "zaoan shoes", chance = 648 },
	{ name = "zaoan legs", chance = 752 },
	{ name = "spiked iron ball", chance = 7912 },
	{ name = "corrupted flag", chance = 2680 },
	{ name = "cursed shoulder spikes", chance = 4640 },
	{ name = "scale of corruption", chance = 2296 },
	{ id = 50152, chance = 832 }, -- collar of orange plasma
}
