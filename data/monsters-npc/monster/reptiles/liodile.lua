...
monster.loot = {
	{ name = "platinum coin", chance = 64432, maxCount = 23 },
	{ name = "small sapphire", chance = 7832, maxCount = 4 },
	{ name = "green crystal shard", chance = 4288 },
	{ name = "liodile fang", chance = 3224, maxCount = 3 },
	{ name = "yellow gem", chance = 2976 },
	{ name = "assassin dagger", chance = 2080 },
	{ name = "terra legs", chance = 1936 },
	{ name = "springsprout rod", chance = 1288 },
	{ name = "sacred tree amulet", chance = 664 },
	{ name = "leviathan's amulet", chance = 576 },
}
