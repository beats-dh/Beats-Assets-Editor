...
monster.loot = {
	{ name = "gold coin", chance = 47200, maxCount = 30 },
	{ name = "battle hammer", chance = 584 },
	{ name = "plate shield", chance = 2280 },
	{ id = 3578, chance = 3680 }, -- fish
	{ name = "tortoise egg", chance = 616, maxCount = 2 },
	{ id = 5899, chance = 1040 }, -- turtle shell
	{ name = "tortoise shield", chance = 160 },
}
