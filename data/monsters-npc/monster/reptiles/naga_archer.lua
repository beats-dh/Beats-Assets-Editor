...
monster.loot = {
	{ name = "platinum coin", chance = 80000, maxCount = 17 },
	{ name = "naga archer scales", chance = 12040, maxCount = 3 },
	{ name = "naga earring", chance = 10280, maxCount = 3 },
	{ name = "naga armring", chance = 4768, maxCount = 3 },
	{ id = 3007, chance = 4264 }, -- crystal ring
	{ name = "hunting spear", chance = 3008 },
	{ name = "crossbow", chance = 2504 },
	{ name = "blue crystal shard", chance = 1504 },
	{ name = "bow", chance = 1256 },
	{ name = "elvish bow", chance = 600 },
	{ name = "ornate crossbow", chance = 504 },
	{ name = "crystal crossbow", chance = 336 },
	{ id = 7441, chance = 504 }, -- ice cube
	{ name = "emerald bangle", chance = 744 },
	{ name = "silver brooch", chance = 248 },
}
...
monster.attacks = {
	...
	{ name = "nagadeath", interval = 3000, chance = 15, minDamage = -380, maxDamage = -470, target = false }, -- short_death_wave
	{ name = "death chain", interval = 3500, chance = 12, minDamage = -460, maxDamage = -520, range = 6, target = true }, -- death_chain
