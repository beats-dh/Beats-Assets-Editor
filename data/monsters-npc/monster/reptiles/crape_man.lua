...
monster.loot = {
	{ name = "platinum coin", chance = 57232, maxCount = 25 },
	{ name = "crab man claws", chance = 4168, maxCount = 2 },
	{ name = "green gem", chance = 2408 },
	{ name = "great health potion", chance = 1600, maxCount = 5 },
	{ id = 281, chance = 1360 }, -- giant shimmering pearl (green)
	{ name = "guardian halberd", chance = 1920 },
	{ name = "lightning legs", chance = 1320 },
	{ name = "warrior's shield", chance = 1320 },
	{ name = "glacier kilt", chance = 1240 },
	{ name = "noble axe", chance = 1120 },
	{ name = "hammer of wrath", chance = 1160 },
