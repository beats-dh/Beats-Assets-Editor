...
monster.loot = {
	{ name = "small ruby", chance = 7176, maxCount = 5 },
	{ name = "gold coin", chance = 61784, maxCount = 50 },
	{ name = "platinum coin", chance = 10720, maxCount = 19 },
	{ name = "lizard leather", chance = 176 },
	{ name = "lizard scale", chance = 360 },
	{ name = "strong mana potion", chance = 5024 },
	{ name = "great mana potion", chance = 3584 },
}
