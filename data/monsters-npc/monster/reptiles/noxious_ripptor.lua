...
monster.loot = {
	{ name = "Crystal Coin", chance = 21416, minCount = 1, maxCount = 2 },
	{ name = "Ripptor Scales", chance = 10280 },
	{ name = "Ultimate Health Potion", chance = 8456, minCount = 1, maxCount = 2 },
	{ name = "Ripptor Claw", chance = 6624, minCount = 1, maxCount = 2 },
	{ name = "Serpent Sword", chance = 1152 },
	{ name = "Sacred Tree Amulet", chance = 1088 },
	{ name = "Muck Rod", chance = 1032 },
