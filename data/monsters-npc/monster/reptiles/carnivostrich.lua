...
monster.loot = {
	{ name = "platinum coin", chance = 64360, maxCount = 28 },
	{ name = "small ruby", chance = 13112, maxCount = 8 },
	{ name = "small emerald", chance = 6664, maxCount = 8 },
	{ name = "strong mana potion", chance = 3928, maxCount = 4 },
	{ name = "carnivostrich feather", chance = 2776, maxCount = 4 },
	{ name = "underworld rod", chance = 1936 },
	{ name = "wand of voodoo", chance = 1688 },
	{ name = "blue gem", chance = 1672 },
	{ name = "spellbook of mind control", chance = 1240 },
	{ name = "boots of haste", chance = 760 },
}
