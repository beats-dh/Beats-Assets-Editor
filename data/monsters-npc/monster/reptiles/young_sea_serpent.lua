...
monster.loot = {
	{ name = "small sapphire", chance = 1520, maxCount = 2 },
	{ name = "gold coin", chance = 40000, maxCount = 100 },
	{ name = "gold coin", chance = 38400, maxCount = 74 },
	{ id = 3049, chance = 800 }, -- stealth ring
	{ name = "life crystal", chance = 240 },
	{ name = "battle axe", chance = 6400 },
	{ name = "morning star", chance = 32000 },
	{ name = "battle hammer", chance = 4000 },
	{ name = "strong health potion", chance = 4000 },
	{ name = "strong mana potion", chance = 3200 },
	{ id = 8894, chance = 6352 }, -- heavily rusted armor
	{ id = 8895, chance = 6352 }, -- rusted armor
	{ name = "sea serpent scale", chance = 4000 },
}
