...
monster.loot = {
	{ name = "gold coin", chance = 24000, maxCount = 242 },
	{ name = "platinum coin", chance = 7936, maxCount = 2 },
	{ name = "war hammer", chance = 808 },
	{ name = "knight armor", chance = 696 },
	{ name = "spiked squelcher", chance = 128 },
	{ name = "strong health potion", chance = 4000, maxCount = 2 },
	{ name = "strong mana potion", chance = 4000, maxCount = 2 },
	{ name = "small topaz", chance = 6352, maxCount = 2 },
	{ name = "stampor horn", chance = 3936 },
	{ name = "stampor talons", chance = 7960, maxCount = 2 },
	{ name = "hollow stampor hoof", chance = 2416 },
}
