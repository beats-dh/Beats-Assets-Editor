...
monster.loot = {
	{ name = "platinum coin", chance = 57808, maxCount = 30 },
	{ name = "brown crystal splinter", chance = 9240, maxCount = 4 },
	{ name = "rhindeer antlers", chance = 4816 },
	{ name = "rainbow quartz", chance = 3952, maxCount = 2 },
	{ name = "great mana potion", chance = 2136, maxCount = 4 },
	{ name = "titan axe", chance = 1976 },
	{ name = "yellow gem", chance = 1504 },
	{ name = "knight armor", chance = 1584 },
	{ name = "violet gem", chance = 1360 },
	{ id = 23543, chance = 1000 }, -- collar of green plasma
	{ name = "heavy mace", chance = 1080 },
	{ name = "mastermind shield", chance = 1240 },
	{ id = 3053, chance = 1160 }, -- time ring
}
