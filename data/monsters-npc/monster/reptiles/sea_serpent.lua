...
monster.loot = {
	{ name = "small sapphire", chance = 4480, maxCount = 3 },
	{ name = "gold coin", chance = 30400, maxCount = 100 },
	{ name = "gold coin", chance = 24000, maxCount = 100 },
	{ name = "gold coin", chance = 24000, maxCount = 36 },
	{ name = "platinum coin", chance = 20000, maxCount = 3 },
	{ id = 3049, chance = 320 }, -- stealth ring
	{ id = 3098, chance = 880 }, -- ring of healing
	{ name = "serpent sword", chance = 3360 },
	{ name = "plate legs", chance = 5720 },
	{ name = "dragon ham", chance = 48000, maxCount = 2 },
	{ name = "strong health potion", chance = 4400 },
	{ name = "strong mana potion", chance = 3080 },
	{ name = "great mana potion", chance = 736 },
	{ name = "glacier amulet", chance = 704 },
	{ name = "glacier kilt", chance = 344 },
	{ name = "spirit cloak", chance = 2320 },
	{ name = "focus cape", chance = 296 },
	{ name = "crystalline armor", chance = 72 },
	{ name = "northwind rod", chance = 744 },
	{ name = "sea serpent scale", chance = 8160 },
}
