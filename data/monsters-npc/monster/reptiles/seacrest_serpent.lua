...
monster.loot = {
	{ id = 3583, chance = 10432 }, -- dragon ham
	{ id = 21801, chance = 9632 }, -- seacrest hair
	{ id = 762, chance = 5616, maxCount = 17 }, -- shiver arrow
	{ id = 829, chance = 2144 }, -- glacier mask
	{ id = 21892, chance = 320 }, -- crest of the deep seas
	{ id = 3035, chance = 80000, maxCount = 5 }, -- platinum coin
	{ id = 236, chance = 5616, maxCount = 2 }, -- strong health potion
	{ id = 237, chance = 8296, maxCount = 2 }, -- strong mana potion
	{ id = 21747, chance = 8024 }, -- seacrest pearl
	{ id = 3026, chance = 2944, maxCount = 2 }, -- white pearl
	{ id = 3027, chance = 1872, maxCount = 3 }, -- black pearl
	{ id = 281, chance = 800 }, -- giant shimmering pearl (green)
	{ id = 5944, chance = 2672 }, -- soul orb
	{ id = 3028, chance = 4016, maxCount = 3 }, -- small diamond
	{ id = 21800, chance = 13912 }, -- seacrest scale
	{ id = 815, chance = 536 }, -- glacier amulet
	{ id = 823, chance = 2944 }, -- glacier kilt
	{ id = 819, chance = 2408 }, -- glacier shoes
	{ id = 16096, chance = 536 }, -- wand of defiance
	{ id = 8093, chance = 536 }, -- wand of draconia
}
