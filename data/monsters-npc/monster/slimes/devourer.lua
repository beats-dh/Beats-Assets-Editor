...
monster.loot = {
	...
	{ id = 3035, chance = 7280, maxCount = 2 }, -- platinum coin
	{ id = 21182, chance = 1336 }, -- glob of glooth
	{ id = 3034, chance = 752 }, -- talon
	{ id = 3029, chance = 936, maxCount = 3 }, -- small sapphire
	{ id = 3033, chance = 824, maxCount = 3 }, -- small amethyst
	{ id = 9057, chance = 824, maxCount = 3 }, -- small topaz
	{ id = 3032, chance = 936, maxCount = 3 }, -- small emerald
	{ id = 3030, chance = 952, maxCount = 3 }, -- small ruby
	{ id = 3028, chance = 840, maxCount = 3 }, -- small diamond
	{ id = 3037, chance = 872 }, -- yellow gem
	{ id = 3038, chance = 80 }, -- green gem
	{ id = 21164, chance = 168 }, -- glooth cape
	{ id = 21183, chance = 104 }, -- glooth amulet
	{ id = 21179, chance = 280 }, -- glooth blade
	{ id = 21178, chance = 408 }, -- glooth club
	{ id = 21180, chance = 312 }, -- glooth axe
	{ id = 21158, chance = 296 }, -- glooth spear
	{ id = 8084, chance = 200 }, -- springsprout rod
	{ id = 3065, chance = 208 }, -- terra rod
}
