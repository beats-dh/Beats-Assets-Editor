...
monster.loot = {
	{ id = 2828, chance = 728 }, -- book
	{ name = "piggy bank", chance = 104 },
	{ name = "small sapphire", chance = 440 },
	{ name = "gold coin", chance = 51640, maxCount = 70 },
	{ id = 3051, chance = 360 }, -- energy ring
	{ name = "platinum amulet", chance = 160 },
	{ name = "wand of inferno", chance = 144 },
	{ name = "protection amulet", chance = 632 },
	{ name = "skull staff", chance = 280 },
	{ name = "blue robe", chance = 32 },
	{ name = "jewelled backpack", chance = 80 },
	{ name = "pirate voodoo doll", chance = 344 },
	{ id = 6090, chance = 392 }, -- music sheet
	{ name = "amber staff", chance = 80 },
	{ name = "strong mana potion", chance = 592 },
	{ name = "cultish mask", chance = 8200 },
	{ name = "cultish symbol", chance = 712 },
	{ name = "broken key ring", chance = 80 },
}
