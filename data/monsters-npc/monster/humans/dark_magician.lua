...
monster.loot = {
	{ name = "gold coin", chance = 60080, maxCount = 55 },
	{ name = "blank rune", chance = 8000 },
	{ name = "strong health potion", chance = 2400 },
	{ name = "strong mana potion", chance = 2288 },
	{ name = "health potion", chance = 9600 },
	{ name = "mana potion", chance = 9520 },
	{ name = "reins", chance = 16 },
}
