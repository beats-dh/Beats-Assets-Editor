...
monster.loot = {
	{ id = 2828, chance = 584 }, -- book
	{ name = "gold coin", chance = 53552, maxCount = 40 },
	{ name = "small emerald", chance = 440 },
	{ id = 3052, chance = 448 }, -- life ring
	{ name = "terra rod", chance = 200 },
	{ name = "dragon necklace", chance = 840 },
	{ name = "morning star", chance = 3992 },
	{ name = "pirate voodoo doll", chance = 848 },
	{ id = 6088, chance = 384 }, -- music sheet
	{ name = "cultish robe", chance = 6456 },
	{ name = "cultish symbol", chance = 32 },
	{ name = "rope belt", chance = 8336 },
	{ name = "broken key ring", chance = 48 },
}
