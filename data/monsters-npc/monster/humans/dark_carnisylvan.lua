...
monster.loot = {
	...
	{ id = 3115, chance = 31752, maxCount = 1 }, -- bone
	{ name = "carnisylvan finger", chance = 13992, maxCount = 4 },
	{ name = "carnisylvan bark", chance = 9192, maxCount = 5 },
	{ name = "great mana potion", chance = 7728, maxCount = 4 },
	{ name = "underworld rod", chance = 3552 },
	{ name = "wand of starstorm", chance = 2928 },
	{ name = "hailstorm rod", chance = 2928 },
	{ name = "springsprout rod", chance = 2088 },
	{ id = 3059, chance = 1880 }, -- spellbook
	{ name = "spellbook of warding", chance = 2712 },
	{ name = "gold ring", chance = 624 },
	{ name = "butterfly ring", chance = 416 },
	{ name = "human teeth", chance = 832 },
}
