...
monster.loot = {
	...
	{ name = "snakebite rod", chance = 3760 },
	{ name = "underworld rod", chance = 2720 },
	{ name = "violet gem", chance = 2080 },
	{ name = "opal", chance = 1760, maxCount = 2 },
	{ name = "wand of voodoo", chance = 1760 },
	{ id = 31331, chance = 2720 }, -- empty honey glass
	{ name = "small enchanted emerald", chance = 1200, maxCount = 3 },
}
