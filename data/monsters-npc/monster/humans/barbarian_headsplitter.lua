...
monster.loot = {
	{ id = 2920, chance = 48240 }, -- torch
	{ name = "gold coin", chance = 60480, maxCount = 30 },
	{ id = 3052, chance = 184 }, -- life ring
	{ name = "knife", chance = 11912 },
	{ name = "brass helmet", chance = 16112 },
	{ name = "viking helmet", chance = 4016 },
	{ id = 3114, chance = 6400, maxCount = 2 }, -- skull
	{ name = "scale armor", chance = 3248 },
	{ name = "brown piece of cloth", chance = 784 },
	{ name = "fur boots", chance = 72 },
	{ name = "krimhorn helmet", chance = 88 },
	{ name = "health potion", chance = 448 },
}
