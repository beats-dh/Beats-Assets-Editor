...
monster.loot = {
	{ name = "gold coin", chance = 62400, maxCount = 50 },
	{ name = "scale armor", chance = 2400 },
	{ name = "steel shield", chance = 2240 },
	{ id = 5090, chance = 800 }, -- treasure map
	{ name = "rum flask", chance = 72 },
	{ name = "light shovel", chance = 1600 },
	{ id = 5792, chance = 88 }, -- die
	{ name = "pirate knee breeches", chance = 784 },
	{ name = "pirate bag", chance = 800 },
	{ name = "hook", chance = 440 },
	{ name = "eye patch", chance = 360 },
	{ name = "peg leg", chance = 400 },
	{ name = "compass", chance = 8096 },
}
