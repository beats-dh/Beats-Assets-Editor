...
monster.loot = {
	...
	{ name = "gold coin", chance = 40000, maxCount = 88 },
	{ name = "sabre", chance = 8000 },
	{ name = "throwing star", chance = 6720, maxCount = 12 },
	{ name = "dark armor", chance = 1320 },
	{ name = "dark shield", chance = 800 },
	{ name = "pirate boots", chance = 176 },
	{ name = "rum flask", chance = 104 },
	{ id = 5813, chance = 104 }, -- skull candle
	{ name = "pirate backpack", chance = 744 },
	{ name = "pirate hat", chance = 920 },
	{ name = "hook", chance = 480 },
	{ name = "eye patch", chance = 400 },
	{ name = "peg leg", chance = 480 },
	{ name = "strong health potion", chance = 656 },
	{ name = "compass", chance = 8840 },
	{ name = "compass", chance = 8816 },
}
