...
monster.loot = {
	{ name = "gold coin", chance = 24000, maxCount = 65 },
	{ name = "gold coin", chance = 24000, maxCount = 50 },
	{ id = 3046, chance = 1600 }, -- magic light wand
	{ name = "life crystal", chance = 1600 },
	{ name = "cookie", chance = 960, maxCount = 5 },
	{ name = "white mushroom", chance = 6400, maxCount = 3 },
	{ name = "mastermind potion", chance = 104 },
	{ name = "health potion", chance = 15200 },
	{ name = "mana potion", chance = 15200 },
	{ name = "small enchanted amethyst", chance = 376 },
}
