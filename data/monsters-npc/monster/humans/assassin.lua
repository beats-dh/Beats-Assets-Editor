...
monster.loot = {
	{ id = 2920, chance = 23984, maxCount = 2 }, -- torch
	{ name = "small diamond", chance = 176 },
	{ name = "gold coin", chance = 66568, maxCount = 50 },
	{ name = "gold coin", chance = 5800, maxCount = 14 },
	{ name = "knife", chance = 7600 },
	{ name = "combat knife", chance = 3200 },
	{ name = "steel helmet", chance = 2584 },
	{ name = "steel shield", chance = 776 },
	{ name = "plate shield", chance = 1520 },
	{ name = "battle shield", chance = 1280 },
	{ name = "leopard armor", chance = 384 },
	{ name = "horseman helmet", chance = 184 },
	{ name = "viper star", chance = 3360, maxCount = 7 },
}
