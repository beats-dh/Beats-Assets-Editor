...
monster.loot = {
	{ name = "platinum coin", chance = 56000, maxCount = 17 },
	{ name = "carnisylvan bark", chance = 9632, maxCount = 2 },
	{ name = "mushroom pie", chance = 6912, maxCount = 1 },
	{ name = "carnisylvan finger", chance = 6912, maxCount = 4 },
	{ name = "emerald bangle", chance = 3976 },
	{ name = "great spirit potion", chance = 5448, maxCount = 5 },
	{ name = "guardian halberd", chance = 3976 },
	{ id = 23542, chance = 3976 }, -- collar of blue plasma
	{ name = "terra rod", chance = 5864 },
	{ name = "underworld rod", chance = 5024 },
	{ name = "diamond sceptre", chance = 3768 },
	{ name = "fire mushroom", chance = 2512 },
	{ name = "knight axe", chance = 4608 },
	{ name = "wand of starstorm", chance = 3768 },
	{ name = "sacred tree amulet", chance = 2304 },
	{ id = 281, chance = 1672 }, -- giant shimmering pearl (green)
	{ name = "gemmed figurine", chance = 632 },
	{ name = "human teeth", chance = 416 },
}
