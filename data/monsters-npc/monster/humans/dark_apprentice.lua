...
monster.loot = {
	{ name = "gold coin", chance = 6000, maxCount = 45 },
	{ name = "wand of decay", chance = 88 },
	{ name = "wand of dragonbreath", chance = 1584 },
	{ name = "blank rune", chance = 6500, maxCount = 3 },
	{ name = "health potion", chance = 2320 },
	{ name = "mana potion", chance = 2384 },
	{ name = "reins", chance = 8 },
}
