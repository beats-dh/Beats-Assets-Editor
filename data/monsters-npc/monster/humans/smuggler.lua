...
monster.loot = {
	{ id = 2920, chance = 24160, maxCount = 2 }, -- torch
	{ name = "gold coin", chance = 64000, maxCount = 10 },
	{ id = 3264, chance = 4000 }, -- sword
	{ name = "knife", chance = 7936 },
	{ name = "combat knife", chance = 3520 },
	{ name = "short sword", chance = 8000 },
	{ name = "leather helmet", chance = 8040 },
	{ name = "leather legs", chance = 11872 },
	{ name = "ham", chance = 8160 },
	{ id = 7397, chance = 88 }, -- deer trophy
	{ name = "raspberry", chance = 4000, maxCount = 5 },
}
