...
monster.loot = {
	{ name = "spear", chance = 44000, maxCount = 3 },
	{ name = "gold coin", chance = 25600, maxCount = 12 },
	{ name = "meat", chance = 24000 },
	{ name = "chain armor", chance = 8000 },
	{ name = "red apple", chance = 6000, maxCount = 2 },
	{ name = "girlish hair decoration", chance = 4720 },
	{ name = "hunting spear", chance = 4124 },
	{ name = "protective charm", chance = 2560 },
	{ name = "protection amulet", chance = 880 },
	{ name = "plate armor", chance = 664 },
	{ id = 3114, chance = 608 }, -- skull
	{ name = "health potion", chance = 400 },
	{ name = "double axe", chance = 344 },
	{ name = "small diamond", chance = 104 },
}
