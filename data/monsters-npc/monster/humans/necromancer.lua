...
monster.loot = {
	{ name = "gold coin", chance = 24040, maxCount = 90 },
	{ name = "boots of haste", chance = 168 },
	{ name = "clerical mace", chance = 312 },
	{ name = "skull staff", chance = 80 },
	{ name = "poison arrow", chance = 12000, maxCount = 5 },
	{ name = "mystic turban", chance = 400 },
	{ name = "green mushroom", chance = 1176 },
	{ name = "noble axe", chance = 8 },
	{ name = "strong mana potion", chance = 240 },
	{ name = "spellbook of warding", chance = 104 },
	{ name = "book of necromantic rituals", chance = 8104 },
	{ name = "necromantic robe", chance = 801 },
}
