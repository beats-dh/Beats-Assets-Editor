...
monster.loot = {
	{ id = 2920, chance = 3344 }, -- torch
	{ name = "bow", chance = 11944 },
	{ name = "leather helmet", chance = 24480 },
	{ name = "arrow", chance = 39600, maxCount = 17 },
	{ name = "poison arrow", chance = 2344, maxCount = 3 },
	{ id = 3481, chance = 568 }, -- closed trap
	{ name = "leather legs", chance = 21392 },
	{ name = "roll", chance = 8888, maxCount = 2 },
}
