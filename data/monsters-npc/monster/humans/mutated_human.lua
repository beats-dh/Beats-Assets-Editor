...
monster.loot = {
	{ name = "gold coin", chance = 35200, maxCount = 80 },
	{ name = "gold coin", chance = 35200, maxCount = 50 },
	{ name = "strange talisman", chance = 3984 },
	{ name = "silver amulet", chance = 56 },
	{ name = "fishbone", chance = 8040 },
	{ id = 3264, chance = 4024 }, -- sword
	{ name = "scale armor", chance = 6464 },
	{ id = 3607, chance = 6400 }, -- cheese
	{ name = "fern", chance = 336 },
	{ name = "worm", chance = 5688, maxCount = 2 },
	{ name = "peanut", chance = 464 },
	{ id = 8894, chance = 152 }, -- heavily rusted armor
	{ name = "mutated flesh", chance = 15952 },
}
