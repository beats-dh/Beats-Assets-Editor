...
monster.loot = {
	{ name = "platinum coin", chance = 56000, maxCount = 30 },
	{ id = 3115, chance = 22136, maxCount = 1 }, -- bone
	{ name = "great health potion", chance = 11992, maxCount = 4 },
	{ name = "carnisylvan bark", chance = 9680, maxCount = 1 },
	{ name = "carnisylvan finger", chance = 8072, maxCount = 2 },
	{ name = "terra hood", chance = 5760 },
	{ name = "terra boots", chance = 3920 },
	{ name = "knight axe", chance = 2768 },
	{ name = "lightning headband", chance = 2768 },
	{ name = "dragonbone staff", chance = 4152 },
	{ name = "diamond sceptre", chance = 3456 },
	{ name = "epee", chance = 2072 },
	{ name = "war hammer", chance = 3000 },
	{ name = "human teeth", chance = 464 },
}
