...
monster.loot = {
	{ id = 2815, chance = 1600 }, -- scroll
	{ name = "brown flask", chance = 656 },
	{ id = 2914, chance = 704 }, -- lamp
	{ name = "gold coin", chance = 12000, maxCount = 18 },
	{ id = 3050, chance = 80 }, -- power ring
	{ name = "life crystal", chance = 802 },
	{ name = "ankh", chance = 1792 },
	{ id = 3289, chance = 352 }, -- staff
	{ name = "sandals", chance = 568 },
	{ name = "bread", chance = 16000 },
	{ name = "book of prayers", chance = 3944 },
	{ name = "rope belt", chance = 2360 },
	{ name = "safety pin", chance = 801 },
}
