...
monster.loot = {
	{ id = 2824, chance = 3800 }, -- book
	{ name = "gold coin", chance = 72184, maxCount = 15 },
	{ id = 3289, chance = 5240 }, -- staff
	{ name = "chain armor", chance = 7440 },
	{ name = "corncob", chance = 8752, maxCount = 2 },
	{ name = "hunting spear", chance = 4160 },
	{ name = "fur bag", chance = 6072 },
	{ name = "brutetamer's staff", chance = 272 },
	{ name = "fur boots", chance = 136 },
	{ name = "mammoth fur cape", chance = 120 },
	{ name = "mammoth fur shorts", chance = 72 },
	{ name = "mana potion", chance = 464 },
}
