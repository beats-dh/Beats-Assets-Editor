...
monster.loot = {
	{ id = 2828, chance = 752 }, -- book
	{ name = "small ruby", chance = 256 },
	{ name = "gold coin", chance = 52416, maxCount = 60 },
	{ id = 3053, chance = 336 }, -- time ring
	{ name = "silver amulet", chance = 816 },
	{ name = "hailstorm rod", chance = 176 },
	{ name = "clerical mace", chance = 1008 },
	{ name = "red robe", chance = 64 },
	{ name = "pirate voodoo doll", chance = 1384 },
	{ id = 6089, chance = 560 }, -- music sheet
	{ name = "lunar staff", chance = 96 },
	{ name = "amber staff", chance = 544 },
	{ name = "cultish robe", chance = 8064 },
	{ name = "cultish symbol", chance = 72 },
	{ name = "rope belt", chance = 8000 },
	{ name = "broken key ring", chance = 96 },
}
