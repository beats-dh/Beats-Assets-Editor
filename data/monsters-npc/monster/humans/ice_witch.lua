...
monster.loot = {
	{ name = "gold coin", chance = 23704, maxCount = 90 },
	{ name = "clerical mace", chance = 736 },
	{ name = "mystic turban", chance = 344 },
	{ name = "green mushroom", chance = 1048 },
	{ name = "shard", chance = 424 },
	{ name = "diamond sceptre", chance = 264 },
	{ id = 7441, chance = 8000 }, -- ice cube
	{ name = "crystal sword", chance = 320 },
	{ name = "pair of earmuffs", chance = 72 },
	{ name = "strong mana potion", chance = 656 },
