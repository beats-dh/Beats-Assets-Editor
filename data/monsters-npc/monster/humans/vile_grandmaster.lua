...
monster.loot = {
	{ id = 7364, chance = 968, maxCount = 4 }, -- sniper arrow
	{ id = 3031, chance = 60328, maxCount = 30 }, -- gold coin
	{ id = 3035, chance = 60328, maxCount = 2 }, -- platinum coin
	{ id = 3592, chance = 968 }, -- grapes
	{ id = 3577, chance = 968, maxCount = 2 }, -- meat
	{ id = 239, chance = 968 }, -- great health potion
	{ id = 3269, chance = 1288 }, -- halberd
	{ id = 3658, chance = 408 }, -- red rose
	{ id = 3003, chance = 1208 }, -- rope
	{ id = 11510, chance = 728 }, -- scroll of heroic deeds
	{ id = 11450, chance = 728 }, -- small notebook
	{ id = 3030, chance = 648, maxCount = 2 }, -- small ruby
	{ id = 3029, chance = 648, maxCount = 2 }, -- small sapphire
	{ id = 3004, chance = 408 }, -- wedding ring
	{ id = 5911, chance = 168 }, -- red piece of cloth
	{ id = 3279, chance = 168 }, -- war hammer
	{ id = 3381, chance = 248 }, -- crown armor
	{ id = 3280, chance = 168 }, -- fire sword
	{ id = 3385, chance = 248 }, -- crown helmet
	{ id = 3419, chance = 168 }, -- crown shield
	{ id = 3382, chance = 88 }, -- crown legs
	{ id = 3055, chance = 168 }, -- platinum amulet
}
