...
monster.loot = {
	{ name = "gold coin", chance = 10400, maxCount = 8 },
	{ name = "blank rune", chance = 6936 },
	{ name = "throwing knife", chance = 8936, maxCount = 2 },
	{ name = "katana", chance = 424 },
	{ name = "obsidian lance", chance = 968 },
	{ name = "brass legs", chance = 2800 },
	{ name = "brass shield", chance = 4408 },
	{ name = "miraculum", chance = 1240 },
}
