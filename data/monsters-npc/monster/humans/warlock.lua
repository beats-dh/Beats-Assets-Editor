...
monster.loot = {
	{ name = "red tome", chance = 240 },
	{ name = "candlestick", chance = 1200 },
	{ name = "piggy bank", chance = 48 },
	{ name = "ring of the sky", chance = 344 },
	{ id = 3007, chance = 560 }, -- crystal ring
	{ name = "small sapphire", chance = 952 },
	{ name = "gold coin", chance = 23472, maxCount = 80 },
	{ name = "talon", chance = 920 },
	{ id = 3051, chance = 1760 }, -- energy ring
	{ name = "mind stone", chance = 1600 },
	{ name = "stone skin amulet", chance = 264 },
	{ name = "poison dagger", chance = 6080 },
	{ name = "skull staff", chance = 5096 },
	{ name = "golden armor", chance = 192 },
	{ id = 3509, chance = 800 }, -- inkwell
	{ name = "blue robe", chance = 1128 },
	{ name = "cherry", chance = 15200, maxCount = 4 },
	{ name = "bread", chance = 7200 },
	{ name = "dark mushroom", chance = 2400 },
	{ name = "assassin star", chance = 2800, maxCount = 4 },
	{ name = "assassin star", chance = 2776, maxCount = 4 },
	{ name = "great mana potion", chance = 3808 },
	{ name = "great health potion", chance = 4152 },
	{ name = "lightning robe", chance = 800 },
	{ name = "luminous orb", chance = 408 },
}
