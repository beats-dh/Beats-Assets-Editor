...
monster.loot = {
	{ name = "gold coin", chance = 51272, maxCount = 23 },
	{ name = "meat", chance = 15960, maxCount = 2 },
	{ id = 3578, chance = 16256, maxCount = 2 }, -- fish
	{ name = "worm", chance = 11784, maxCount = 2 },
	{ name = "marsh stalker feather", chance = 6920 },
	{ name = "longsword", chance = 6048 },
	{ name = "marsh stalker beak", chance = 4864 },
	{ id = 3003, chance = 3864 }, -- rope
	{ name = "seeds", chance = 88 },
}
