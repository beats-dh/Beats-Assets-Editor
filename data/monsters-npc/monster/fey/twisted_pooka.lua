...
monster.loot = {
	{ name = "carrot on a stick", chance = 16 },
	{ name = "small stone", chance = 160, maxCount = 5 },
	{ name = "gold coin", chance = 24000, maxCount = 100 },
	{ id = 3049, chance = 394 }, -- stealth ring
	{ id = 3595, chance = 44000, maxCount = 3 }, -- carrot
	{ name = "strong health potion", chance = 575 },
	{ name = "orange mushroom", chance = 8000 },
	{ name = "fairy wings", chance = 24080 },
	{ name = "orange mushroom", chance = 4124 },
	{ name = "shimmering beetles", chance = 473 },
	{ name = "prismatic quartz", chance = 2000 },
	{ name = "crystal of focus", chance = 48 },
	{ name = "small enchanted ruby", chance = 2720, maxCount = 2 },
}
