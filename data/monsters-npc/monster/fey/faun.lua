...
monster.loot = {
	{ name = "gold coin", chance = 24000, maxCount = 136 },
	{ name = "goat grass", chance = 4124 },
	{ name = "leaf star", chance = 8000, maxCount = 7 },
	{ name = "grapes", chance = 24080, maxCount = 2 },
	{ name = "small enchanted sapphire", chance = 394, maxCount = 2 },
	{ name = "leaf legs", chance = 394 },
	{ name = "dandelion seeds", chance = 4640 },
	{ name = "shimmering beetles", chance = 394 },
	{ name = "panpipes", chance = 138 },
	{ name = "cookie", chance = 44000, maxCount = 5 },
	{ name = "great health potion", chance = 5120, maxCount = 2 },
	{ name = "wooden spellbook", chance = 74 },
	{ name = "strong health potion", chance = 5440, maxCount = 2 },
	{ name = "fresh fruit", chance = 2720, maxCount = 3 },
	{ name = "rainbow quartz", chance = 869, maxCount = 4 },
	{ name = "small stone", chance = 394, maxCount = 3 },
	{ name = "wood cape", chance = 394 },
	{ id = 5792, chance = 64 }, -- die
