...
monster.loot = {
	...
	{ name = "small stone", chance = 394, maxCount = 4 },
	{ name = "small enchanted sapphire", chance = 394, maxCount = 2 },
	{ name = "shimmering beetles", chance = 394 },
	{ name = "cave turnip", chance = 44000, maxCount = 4 },
	{ name = "leaf legs", chance = 575 },
	{ name = "dark mushroom", chance = 575 },
	{ name = "panpipes", chance = 575 },
	{ name = "prismatic quartz", chance = 575 },
	{ name = "leaf star", chance = 8000, maxCount = 8 },
	{ name = "strong health potion", chance = 5440, maxCount = 2 },
	{ name = "goat grass", chance = 4124 },
	{ name = "great health potion", chance = 473 },
}
