...
monster.loot = {
	{ name = "gold coin", chance = 24000, maxCount = 90 },
	{ name = "butterfly ring", chance = 394 },
	{ name = "wooden spellbook", chance = 74 },
	{ name = "dream blossom staff", chance = 74 },
	{ id = 3046, chance = 394 }, -- magic light wand
	{ name = "green mushroom", chance = 394 },
	{ name = "small enchanted amethyst", chance = 394, maxCount = 2 },
	{ name = "small topaz", chance = 474, maxCount = 2 },
	{ name = "rainbow quartz", chance = 575, maxCount = 3 },
	{ name = "colourful snail shell", chance = 575 },
	{ name = "star herb", chance = 575 },
	{ name = "leaf star", chance = 8000, maxCount = 5 },
	{ name = "red rose", chance = 24080 },
	{ name = "strong mana potion", chance = 5440 },
	{ name = "wild flowers", chance = 4124 },
	{ name = "great mana potion", chance = 473 },
	{ name = "dandelion seeds", chance = 4640 },
	{ name = "fresh fruit", chance = 2720, maxCount = 2 },
}
