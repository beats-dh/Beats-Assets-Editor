...
monster.loot = {
	{ name = "Crystal Coin", chance = 16560, minCount = 1, maxCount = 2 },
	{ name = "Gorerilla Mane", chance = 15912 },
	{ name = "Gorerilla Tail", chance = 13648 },
	{ name = "Ultimate Mana Potion", chance = 8968, minCount = 1, maxCount = 3 },
	{ name = "Doublet", chance = 4704 },
	{ name = "Magma Coat", chance = 1952 },
	{ name = "Black Pearl", chance = 400, minCount = 1, maxCount = 2 },
	{ name = "Crystal Crossbow", chance = 88 },
	{ name = "Composite Hornbow", chance = 24 },
	{ name = "Ornate Crossbow", chance = 24 },
}
