...
monster.loot = {
	{ name = "Gold Coin", chance = 80000, minCount = 1, maxCount = 285 },
	{ name = "Ham", chance = 19736 },
	{ name = "Parder Fur", chance = 15256 },
	{ name = "Parder Tooth", chance = 11456, minCount = 1, maxCount = 2 },
	{ name = "Red Crystal Fragment", chance = 11224 },
	{ name = "Strong Health Potion", chance = 6048, minCount = 1, maxCount = 3 },
	{ name = "Barbarian Axe", chance = 3632 },
	{ id = 7385, chance = 1208 }, -- Crimson Sword
}
