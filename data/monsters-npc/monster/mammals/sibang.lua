...
monster.loot = {
	{ name = "small stone", chance = 24048, maxCount = 3 },
	{ name = "gold coin", chance = 44800, maxCount = 35 },
	{ name = "orange", chance = 15872, maxCount = 5 },
	{ name = "banana", chance = 24000, maxCount = 12 },
	{ name = "coconut", chance = 1568, maxCount = 3 },
	{ name = "melon", chance = 800 },
	{ name = "ape fur", chance = 800 },
	{ name = "banana sash", chance = 4000 },
}
