...
monster.loot = {
	{ name = "gold coin", chance = 62800, maxCount = 130 },
	{ id = 3049, chance = 432 }, -- stealth ring
	{ id = 3114, chance = 16192 }, -- skull
	{ name = "mouldy cheese", chance = 760 },
	{ name = "halberd", chance = 2392 },
	{ name = "plate shield", chance = 3000 },
	{ name = "tower shield", chance = 40 },
	{ name = "green mushroom", chance = 1112 },
	{ name = "stone herb", chance = 3936 },
	{ name = "health potion", chance = 448 },
	{ name = "spellbook of enlightenment", chance = 240 },
	{ name = "mutated rat tail", chance = 3040 },
}
