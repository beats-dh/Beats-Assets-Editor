...
monster.loot = {
	{ name = "gold coin", chance = 44800, maxCount = 52 },
	{ name = "hailstorm rod", chance = 5920 },
	{ name = "meat", chance = 41600, maxCount = 4 },
	{ name = "wolf paw", chance = 2960 },
	{ name = "shiver arrow", chance = 8800, maxCount = 10 },
	{ name = "crystalline armor", chance = 2960 },
}
