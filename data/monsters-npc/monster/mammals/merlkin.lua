...
monster.loot = {
	{ name = "gold coin", chance = 55600, maxCount = 45 },
	{ name = "small amethyst", chance = 208 },
	{ id = 3046, chance = 2400 }, -- magic light wand
	{ name = "wand of decay", chance = 840 },
	{ name = "orange", chance = 800, maxCount = 5 },
	{ name = "banana", chance = 24280, maxCount = 12 },
	{ name = "banana staff", chance = 80 },
	{ name = "ape fur", chance = 800 },
	{ name = "mana potion", chance = 528 },
	{ name = "banana sash", chance = 1440 },
}
