...
monster.loot = {
	{ name = "gold coin", chance = 55200, maxCount = 40 },
	{ id = 3050, chance = 240 }, -- power ring
	{ name = "protection amulet", chance = 792 },
	{ id = 3093, chance = 184 }, -- club ring
	{ name = "plate armor", chance = 760 },
	{ name = "banana", chance = 24000, maxCount = 12 },
	{ name = "ape fur", chance = 784 },
	{ name = "health potion", chance = 456 },
	{ name = "kongra's shoulderpad", chance = 3920 },
}
