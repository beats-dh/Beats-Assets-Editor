...
monster.loot = {
	{ name = "small ruby", chance = 2160, maxCount = 2 },
	{ name = "gold coin", chance = 71200, maxCount = 40 },
	{ name = "meat", chance = 40848, maxCount = 3 },
	{ name = "worm", chance = 52000, maxCount = 7 },
	{ name = "health potion", chance = 15872 },
}
