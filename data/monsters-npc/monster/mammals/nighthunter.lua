...
monster.loot = {
	{ name = "Crystal Coin", chance = 27352 },
	{ name = "Nighthunter Wing", chance = 19496, minCount = 1, maxCount = 2 },
	{ name = "Ultimate Health Potion", chance = 10112, minCount = 1, maxCount = 3 },
	{ name = "Red Crystal Fragment", chance = 3184 },
	{ name = "Green Crystal Shard", chance = 2936 },
	{ name = "Cyan Crystal Fragment", chance = 2464 },
	{ name = "Yellow Gem", chance = 2352 },
	{ name = "Crystal Sword", chance = 1272 },
	{ name = "Warrior's Axe", chance = 1120 },
	{ name = "Spellbook of Mind Control", chance = 768 },
	{ name = "Stone Skin Amulet", chance = 680 },
}
