...
monster.loot = {
	{ name = "black pearl", chance = 576, maxCount = 3 },
	{ name = "gold coin", chance = 74000, maxCount = 130 },
	{ name = "small amethyst", chance = 400, maxCount = 2 },
	{ id = 3051, chance = 792 }, -- energy ring
	{ name = "battle shield", chance = 6208 },
	{ name = "black shield", chance = 56 },
	{ name = "obsidian lance", chance = 5808 },
	{ name = "star herb", chance = 4048 },
	{ name = "bat wing", chance = 3920, maxCount = 2 },
	{ name = "mercenary sword", chance = 88 },
	{ id = 8894, chance = 10024 }, -- heavily rusted armor
	{ id = 8895, chance = 10024, maxCount = 2 }, -- rusted armor
	{ name = "batwing hat", chance = 64 },
	{ name = "mutated bat ear", chance = 3920 },
}
