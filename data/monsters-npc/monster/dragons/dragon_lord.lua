...
monster.loot = {
	{ name = "gold coin", chance = 76240, maxCount = 237 },
	{ name = "dragon ham", chance = 63832, maxCount = 2 },
	{ name = "green mushroom", chance = 9624 },
	{ id = 2842, chance = 7672 }, -- gemmed book
	{ name = "royal spear", chance = 7504, maxCount = 3 },
	{ name = "power bolt", chance = 4736, maxCount = 7 },
	{ name = "small sapphire", chance = 4472 },
	{ id = 3051, chance = 3640 }, -- energy ring
	{ name = "golden mug", chance = 2648 },
	{ name = "red dragon scale", chance = 1552 },
	{ name = "red dragon leather", chance = 920 },
	{ name = "strong health potion", chance = 640 },
	{ name = "life crystal", chance = 520 },
	{ name = "strange helmet", chance = 416 },
	{ name = "tower shield", chance = 328 },
	{ name = "fire sword", chance = 280 },
	{ name = "royal helmet", chance = 208 },
	{ name = "dragon slayer", chance = 176 },
	{ name = "dragon lord trophy", chance = 104 },
	{ name = "dragon scale mail", chance = 72 },
}
