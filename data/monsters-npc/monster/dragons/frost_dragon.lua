...
monster.loot = {
	{ name = "gold coin", chance = 79288, maxCount = 207 },
	{ name = "dragon ham", chance = 66432, maxCount = 2 },
	{ name = "green mushroom", chance = 8568 },
	{ id = 7441, chance = 5000 }, -- ice cube
	{ id = 2842, chance = 6800 }, -- book
	{ name = "power bolt", chance = 4288, maxCount = 6 },
	{ name = "golden mug", chance = 4288 },
	{ id = 3051, chance = 2144 }, -- energy ring
	{ name = "small sapphire", chance = 1432 },
	{ name = "strange helmet", chance = 712 },
	{ name = "life crystal", chance = 712 },
	{ name = "shard", chance = 416 },
	{ name = "ice rapier", chance = 248 },
	{ name = "tower shield", chance = 232 },
	{ name = "royal helmet", chance = 184 },
	{ name = "dragon scale mail", chance = 80 },
	{ name = "dragon slayer", chance = 80 },
}
