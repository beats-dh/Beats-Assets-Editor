...
monster.loot = {
	{ name = "gold coin", chance = 79600, maxCount = 238 },
	{ name = "plate legs", chance = 42616 },
	{ name = "small emerald", chance = 32968, maxCount = 5 },
	{ name = "platinum coin", chance = 26536, maxCount = 2 },
	{ name = "great spirit potion", chance = 26127, maxCount = 2 },
	{ name = "dark armor", chance = 24520 },
	{ name = "great mana potion", chance = 21712, maxCount = 2 },
	{ name = "ultimate health potion", chance = 19296 },
	{ name = "undead heart", chance = 17288 },
	{ name = "zaoan halberd", chance = 13264 },
	{ id = 8896, chance = 12064 }, -- slightly rusted armor
	{ name = "demonic essence", chance = 8440 },
	{ name = "terra boots", chance = 8040 },
	{ name = "twin hooks", chance = 7640 },
	{ name = "ghastly dragon head", chance = 6032 },
	{ name = "soul orb", chance = 5632 },
	{ name = "terra legs", chance = 3616 },
	{ name = "jade hat", chance = 808 },
	{ name = "zaoan armor", chance = 808 },
	{ name = "guardian boots", chance = 808 },
	{ name = "drakinata", chance = 808 },
	{ name = "spellweaver's robe", chance = 400 },
	{ name = "zaoan shoes", chance = 784 },
	{ name = "zaoan legs", chance = 776 },
	{ name = "shiny stone", chance = 664 },
	{ name = "zaoan helmet", chance = 184 },
	{ name = "zaoan sword", chance = 96 },
}
