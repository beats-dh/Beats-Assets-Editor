...
monster.loot = {
	{ name = "gold coin", chance = 71936, maxCount = 102 },
	{ name = "dragon ham", chance = 53016, maxCount = 2 },
	{ name = "steel shield", chance = 12520 },
	{ name = "dragon's tail", chance = 7744 },
	{ name = "crossbow", chance = 7296 },
	{ id = 3449, chance = 6448, maxCount = 10 }, -- burst arrow
	{ name = "longsword", chance = 3064 },
	{ name = "steel helmet", chance = 2792 },
	{ name = "broadsword", chance = 2160 },
	{ name = "plate legs", chance = 1623 },
	{ name = "double axe", chance = 1264 },
	{ name = "strong health potion", chance = 904 },
	{ name = "green dragon leather", chance = 856 },
	{ name = "green dragon scale", chance = 808 },
	{ name = "wand of inferno", chance = 448 },
	{ name = "small diamond", chance = 360 },
	{ name = "serpent sword", chance = 184 },
	{ name = "dragon hammer", chance = 184 },
	{ name = "dragonbone staff", chance = 136 },
	{ name = "life crystal", chance = 136 },
	{ name = "dragon shield", chance = 88 },
}
