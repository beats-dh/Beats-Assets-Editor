...
monster.loot = {
	{ id = 3019, chance = 440 }, -- demonbone amulet
	{ name = "small ruby", chance = 16000, maxCount = 4 },
	...
	{ name = "violet gem", chance = 664 },
	{ name = "green gem", chance = 695 },
	{ id = 3039, chance = 11080 }, -- red gem
	{ name = "dragon hammer", chance = 7200 },
	{ name = "heavy mace", chance = 320 },
	{ name = "war axe", chance = 320 },
	{ name = "golden armor", chance = 440 },
	{ name = "golden legs", chance = 400 },
	{ name = "knight armor", chance = 3992 },
	{ name = "mastermind shield", chance = 640 },
	{ id = 3481, chance = 224 }, -- closed trap
	{ name = "ham", chance = 48000, maxCount = 8 },
	{ name = "soul orb", chance = 26666 },
	{ name = "demonic essence", chance = 36266 },
	{ name = "flask of demonic blood", chance = 20000, maxCount = 4 },
	{ name = "onyx arrow", chance = 8889, maxCount = 15 },
	{ name = "assassin star", chance = 20000, maxCount = 10 },
	{ name = "titan axe", chance = 3544 },
	{ name = "spiked squelcher", chance = 6209 },
	{ name = "great mana potion", chance = 28000 },
	{ name = "great health potion", chance = 25600 },
	{ name = "skullcracker armor", chance = 320 },
	{ name = "gold ingot", chance = 6154, maxCount = 2 },
}
