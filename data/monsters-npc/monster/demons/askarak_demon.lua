...
monster.loot = {
	{ name = "piggy bank", chance = 842 },
	{ name = "gold coin", chance = 40000, maxCount = 100 },
	{ name = "gold coin", chance = 40000, maxCount = 100 },
	{ name = "gold coin", chance = 32000, maxCount = 35 },
	{ name = "small emerald", chance = 5000, maxCount = 4 },
	{ id = 3051, chance = 769 }, -- energy ring
	{ name = "brown mushroom", chance = 3077, maxCount = 5 },
	{ name = "magic sulphur", chance = 82 },
	{ name = "assassin star", chance = 3809, maxCount = 5 },
	{ name = "mastermind potion", chance = 345 },
	{ name = "strong health potion", chance = 4210 },
	{ name = "strong mana potion", chance = 4210 },
	{ name = "terra legs", chance = 98 },
	{ name = "springsprout rod", chance = 410 },
}
