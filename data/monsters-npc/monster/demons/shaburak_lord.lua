...
monster.loot = {
	{ name = "small ruby", chance = 4896, maxCount = 5 },
	{ name = "gold coin", chance = 40000, maxCount = 100 },
	{ name = "gold coin", chance = 40000, maxCount = 78 },
	{ name = "platinum coin", chance = 26666, maxCount = 2 },
	{ id = 3051, chance = 1322 }, -- energy ring
	{ name = "wand of inferno", chance = 640 },
	{ name = "steel boots", chance = 128 },
	{ name = "brown mushroom", chance = 4277 },
	{ name = "magic sulphur", chance = 496 },
	{ name = "bullseye potion", chance = 320 },
	{ name = "strong health potion", chance = 5600 },
	{ name = "strong mana potion", chance = 5600 },
	{ name = "magma coat", chance = 80 },
}
