...
monster.loot = {
	...
	{ name = "gold coin", chance = 40000, maxCount = 86 },
	{ name = "small emerald", chance = 10000, maxCount = 5 },
	{ name = "platinum coin", chance = 28266, maxCount = 4 },
	{ id = 3049, chance = 3636 }, -- stealth ring
	{ name = "giant sword", chance = 256 },
	{ name = "brown mushroom", chance = 5333, maxCount = 5 },
	{ name = "magic sulphur", chance = 592 },
	{ name = "mastermind potion", chance = 1052 },
	{ name = "strong health potion", chance = 11428 },
	{ name = "strong mana potion", chance = 11428 },
	{ name = "terra mantle", chance = 672 },
	{ name = "springsprout rod", chance = 760 },
	{ name = "demonic finger", chance = 336 },
}
