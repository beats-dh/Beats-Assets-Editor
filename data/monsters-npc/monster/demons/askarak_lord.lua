...
monster.loot = {
	...
	{ name = "small emerald", chance = 4706, maxCount = 5 },
	{ name = "platinum coin", chance = 28266, maxCount = 2 },
	{ id = 3051, chance = 485 }, -- energy ring
	{ name = "brown mushroom", chance = 4210, maxCount = 5 },
	{ name = "magic sulphur", chance = 496 },
	{ name = "assassin star", chance = 56, maxCount = 5 },
	{ name = "dreaded cleaver", chance = 24 },
	{ name = "mastermind potion", chance = 600 },
	{ name = "strong health potion", chance = 5000 },
	{ name = "strong mana potion", chance = 6154 },
	{ name = "terra mantle", chance = 56 },
	{ name = "springsprout rod", chance = 808 },
}
