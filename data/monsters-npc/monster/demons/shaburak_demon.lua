...
monster.loot = {
	{ name = "piggy bank", chance = 824 },
	{ name = "small ruby", chance = 3809, maxCount = 5 },
	{ name = "gold coin", chance = 40000, maxCount = 100 },
	{ name = "gold coin", chance = 40000, maxCount = 100 },
	{ name = "gold coin", chance = 40000, maxCount = 50 },
	{ id = 3051, chance = 842 }, -- energy ring
	{ name = "wand of inferno", chance = 451 },
	{ name = "brown mushroom", chance = 3077 },
	{ name = "magic sulphur", chance = 65 },
	{ name = "royal spear", chance = 8000, maxCount = 6 },
	{ name = "bullseye potion", chance = 502 },
	{ name = "strong health potion", chance = 3809 },
	{ name = "strong mana potion", chance = 4000 },
	{ name = "magma legs", chance = 124 },
}
