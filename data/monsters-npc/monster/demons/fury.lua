...
monster.loot = {
	{ id = 3007, chance = 328 }, -- crystal ring
	{ name = "gold coin", chance = 24000, maxCount = 100 },
	{ name = "gold coin", chance = 24000, maxCount = 100 },
	{ name = "gold coin", chance = 30400, maxCount = 69 },
	{ name = "platinum coin", chance = 2240, maxCount = 4 },
	{ name = "terra rod", chance = 16000 },
	{ name = "golden legs", chance = 104 },
	{ name = "steel boots", chance = 632 },
	{ name = "orichalcum pearl", chance = 1200, maxCount = 4 },
	{ name = "red piece of cloth", chance = 3200 },
	{ name = "soul orb", chance = 17200 },
	{ name = "soul orb", chance = 40 },
	{ id = 6300, chance = 48 }, -- death ring
	{ name = "demonic essence", chance = 18000 },
	{ name = "flask of demonic blood", chance = 28000, maxCount = 3 },
	{ name = "assassin dagger", chance = 528 },
	{ name = "noble axe", chance = 1600 },
	{ name = "great health potion", chance = 8400 },
	{ name = "jalapeno pepper", chance = 23424, maxCount = 4 },
}
