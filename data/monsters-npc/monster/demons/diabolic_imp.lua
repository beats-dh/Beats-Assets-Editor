...
monster.loot = {
	...
	{ name = "gold coin", chance = 32000, maxCount = 97 },
	{ name = "gold coin", chance = 2712, maxCount = 7 },
	{ name = "small amethyst", chance = 1800, maxCount = 3 },
	{ id = 3049, chance = 2162 }, -- stealth ring
	{ name = "necrotic rod", chance = 664 },
	{ name = "blank rune", chance = 13333, maxCount = 2 },
	{ name = "double axe", chance = 1595 },
	{ id = 3307, chance = 4528 }, -- scimitar
	{ name = "guardian shield", chance = 6504 },
	{ name = "pitchfork", chance = 40000 },
	{ name = "cleaver", chance = 7064 },
	{ name = "soul orb", chance = 5784 },
	{ id = 6299, chance = 96 }, -- death ring
	{ name = "demonic essence", chance = 6400 },
	{ name = "flask of demonic blood", chance = 20000, maxCount = 2 },
	{ name = "magma coat", chance = 200 },
	{ name = "magma monocle", chance = 344 },
}
