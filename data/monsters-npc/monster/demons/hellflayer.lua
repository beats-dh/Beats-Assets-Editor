...
monster.loot = {
	{ id = 3031, chance = 72000, maxCount = 130 }, -- gold coin
	{ id = 3035, chance = 16000, maxCount = 9 }, -- platinum coin
	{ id = 6558, chance = 3200, maxCount = 3 }, -- flask of demonic blood
	{ id = 9058, chance = 1040, maxCount = 2 }, -- gold ingot
	{ id = 238, chance = 7680, maxCount = 2 }, -- great mana potion
	{ id = 7642, chance = 1840, maxCount = 2 }, -- great spirit potion
	{ id = 3033, chance = 1600, maxCount = 5 }, -- small amethyst
	{ id = 3028, chance = 720, maxCount = 5 }, -- small diamond
	{ id = 3032, chance = 720, maxCount = 5 }, -- small emerald
	{ id = 3030, chance = 1600, maxCount = 5 }, -- small ruby
	{ id = 9057, chance = 720, maxCount = 5 }, -- small topaz
	{ id = 7643, chance = 4240, maxCount = 2 }, -- ultimate health potion
	{ id = 3019, chance = 800 }, -- demonbone amulet
	{ id = 6499, chance = 1280 }, -- demonic essence
	{ id = 281, chance = 640 }, -- giant shimmering pearl (green)
	{ id = 3038, chance = 640 }, -- green gem
	{ id = 818, chance = 400 }, -- magma boots
	{ id = 821, chance = 960 }, -- magma legs
	{ id = 3414, chance = 280 }, -- mastermind shield
	{ id = 22729, chance = 640 }, -- pair of hellflayer horns
	{ id = 3039, chance = 400 }, -- red gem
	{ id = 22866, chance = 224 }, -- rift bow
	{ id = 22867, chance = 144 }, -- rift crossbow
	{ id = 5741, chance = 360 }, -- skull helmet
	{ id = 22727, chance = 160 }, -- rift lance
	{ id = 7413, chance = 720 }, -- titan axe
	{ id = 3360, chance = 600 }, -- golden armor
	{ id = 8074, chance = 720 }, -- spellbook of mind control
	{ id = 3340, chance = 320 }, -- heavy mace
}
