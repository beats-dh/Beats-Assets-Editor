...
monster.loot = {
	{ name = "small enchanted ruby", chance = 8000, maxCount = 5 },
	{ name = "red crystal fragment", chance = 8000, maxCount = 2 },
	{ id = 3039, chance = 8000, maxCount = 3 }, -- red gem
	{ name = "red piece of cloth", chance = 8000, maxCount = 3 },
	{ name = "flask of demonic blood", chance = 9600, maxCount = 5 },
	{ name = "demonic essence", chance = 8000, maxCount = 5 },
	{ id = 3456, chance = 8000 }, -- pick
	{ name = "sample of monster blood", chance = 8000, maxCount = 5 },
}
