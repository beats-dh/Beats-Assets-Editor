...
monster.loot = {
	{ name = "gold coin", chance = 74400, maxCount = 236 },
	{ name = "morning star", chance = 8000 },
	{ name = "warrior helmet", chance = 1509 },
	{ name = "knight legs", chance = 2424 },
	{ name = "red mushroom", chance = 6154, maxCount = 2 },
	{ name = "demonic essence", chance = 7272 },
	{ name = "battle shield", chance = 6000 },
	{ name = "assassin star", chance = 7272, maxCount = 2 },
	{ name = "onyx flail", chance = 82 },
	{ name = "berserk potion", chance = 747 },
	{ name = "spiked squelcher", chance = 776 },
	{ name = "great health potion", chance = 32266 },
	{ name = "ultimate health potion", chance = 7272 },
	{ id = 8895, chance = 2500 }, -- rusted armor
	{ id = 8896, chance = 2500 }, -- slightly rusted armor
	{ id = 9034, chance = 112 }, -- dracoyle statue
	{ id = 9056, chance = 121 }, -- black skull
	{ name = "small topaz", chance = 4706, maxCount = 3 },
	{ name = "hellspawn tail", chance = 16000 },
}
