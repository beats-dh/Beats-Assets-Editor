...
monster.loot = {
	{ name = "gold coin", chance = 32000, maxCount = 90 },
	{ name = "gold coin", chance = 39200, maxCount = 50 },
	{ id = 3578, chance = 15144, maxCount = 3 }, -- fish
	{ name = "quara eye", chance = 10176 },
	{ name = "shrimp", chance = 7984, maxCount = 4 },
	{ name = "small emerald", chance = 4800, maxCount = 2 },
	{ name = "white pearl", chance = 2320 },
	{ name = "black pearl", chance = 2120 },
	{ name = "fish fin", chance = 1672 },
	{ name = "obsidian lance", chance = 1224 },
	{ id = 3098, chance = 752 }, -- ring of healing
	{ name = "wand of cosmic energy", chance = 728 },
	{ name = "knight armor", chance = 416 },
}
