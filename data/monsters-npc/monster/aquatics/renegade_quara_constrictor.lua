...
monster.loot = {
	{ name = "platinum coin", chance = 63424, maxCount = 3 },
	{ name = "quara tentacle", chance = 12192 },
	{ name = "mind stone", chance = 5504 },
	{ id = 3098, chance = 4464 }, -- ring of healing
	{ name = "great mana potion", chance = 4312, maxCount = 5 },
	{ name = "shrimp", chance = 4240, maxCount = 4 },
	{ name = "small amethyst", chance = 4160, maxCount = 2 },
	{ name = "small ruby", chance = 3720, maxCount = 2 },
	{ name = "assassin star", chance = 3568, maxCount = 7 },
	{ name = "vortex bolt", chance = 2976, maxCount = 10 },
	{ name = "violet crystal shard", chance = 968 },
	{ name = "northwind rod", chance = 592 },
	{ name = "fish fin", chance = 296 },
	{ name = "piggy bank", chance = 152 },
}
