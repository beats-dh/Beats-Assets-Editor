...
monster.loot = {
	{ name = "gold coin", chance = 76800, maxCount = 44 },
	{ id = 3578, chance = 15784, maxCount = 3 }, -- fish
	{ name = "deepling scales", chance = 11600 },
	{ name = "eye of a deepling", chance = 5200 },
	{ name = "heavy trident", chance = 2176 },
	{ name = "fish fin", chance = 544 },
}
