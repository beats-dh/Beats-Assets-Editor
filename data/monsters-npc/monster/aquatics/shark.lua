...
monster.loot = {
	...
	{ name = "gold coin", chance = 32800, maxCount = 38 },
	{ id = 3578, chance = 20344, maxCount = 4 }, -- fish
	{ name = "deepling scales", chance = 7696 },
	{ name = "eye of a deepling", chance = 960 },
	{ name = "small sapphire", chance = 872 },
	{ id = 281, chance = 312 }, -- giant shimmering pearl (green)
	{ name = "fish fin", chance = 129 },
}
