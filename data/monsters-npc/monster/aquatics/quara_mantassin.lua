...
monster.loot = {
	...
	{ name = "gold coin", chance = 23200, maxCount = 29 },
	{ name = "mantassin tail", chance = 10080 },
	{ name = "shrimp", chance = 4136, maxCount = 5 },
	{ name = "halberd", chance = 3976 },
	{ name = "small sapphire", chance = 904 },
	{ name = "cape", chance = 872 },
	{ id = 3049, chance = 840 }, -- stealth ring
	{ name = "two handed sword", chance = 792 },
	{ name = "fish fin", chance = 488 },
	{ name = "strange helmet", chance = 80 },
	{ name = "blue robe", chance = 48 },
}
