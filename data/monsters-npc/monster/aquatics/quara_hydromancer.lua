...
monster.loot = {
	{ name = "gold coin", chance = 40000, maxCount = 60 },
	{ name = "gold coin", chance = 32000, maxCount = 50 },
	{ name = "quara eye", chance = 12744 },
	{ name = "white pearl", chance = 4200 },
	{ name = "small emerald", chance = 4089, maxCount = 2 },
	{ name = "shrimp", chance = 3636, maxCount = 5 },
	{ name = "black pearl", chance = 2520 },
	{ name = "great mana potion", chance = 2304 },
	{ name = "fish fin", chance = 1128 },
	{ id = 3098, chance = 974 }, -- ring of healing
	{ name = "wand of cosmic energy", chance = 784 },
	{ name = "knight armor", chance = 184 },
}
