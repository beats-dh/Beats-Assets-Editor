...
monster.loot = {
	...
	{ name = "platinum coin", chance = 32000 },
	{ name = "quara pincers", chance = 11428 },
	{ name = "great health potion", chance = 8504 },
	{ name = "small ruby", chance = 6209, maxCount = 2 },
	{ name = "halberd", chance = 5489 },
	{ name = "shrimp", chance = 4196, maxCount = 5 },
	{ name = "fish fin", chance = 1280 },
	{ name = "warrior helmet", chance = 1168 },
	{ name = "crown armor", chance = 224 },
	{ name = "glacier robe", chance = 96 },
	{ name = "giant shrimp", chance = 32 },
}
