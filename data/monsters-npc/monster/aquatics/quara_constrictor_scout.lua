...
monster.loot = {
	{ name = "gold coin", chance = 70096, maxCount = 100 },
	{ name = "quara tentacle", chance = 11696 },
	{ name = "longsword", chance = 5528 },
	{ name = "shrimp", chance = 4112, maxCount = 3 },
	{ name = "brass armor", chance = 3848 },
	{ name = "small amethyst", chance = 2448 },
	{ name = "fish fin", chance = 392 },
}
