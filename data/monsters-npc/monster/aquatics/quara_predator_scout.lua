...
monster.loot = {
	...
	{ name = "gold coin", chance = 38400, maxCount = 72 },
	{ name = "quara bone", chance = 8120 },
	{ name = "scale armor", chance = 7168 },
	{ name = "double axe", chance = 4616 },
	{ name = "shrimp", chance = 4040, maxCount = 5 },
	{ name = "small diamond", chance = 4016, maxCount = 2 },
	{ name = "two handed sword", chance = 2408 },
	{ name = "fish fin", chance = 864 },
	{ name = "northwind rod", chance = 768 },
}
