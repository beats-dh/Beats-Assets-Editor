...
monster.loot = {
	{ name = "gold coin", chance = 75200, maxCount = 30 },
	{ name = "mantassin tail", chance = 6224 },
	{ name = "chain armor", chance = 4049 },
	{ id = 3114, chance = 792 }, -- skull
	{ name = "small sapphire", chance = 792 },
	{ name = "two handed sword", chance = 648 },
	{ id = 3049, chance = 568 }, -- stealth ring
	{ name = "fish fin", chance = 288 },
}
