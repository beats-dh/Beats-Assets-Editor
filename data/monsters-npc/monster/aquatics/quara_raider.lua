...
monster.loot = {
	{ id = 3035, chance = 28000, maxCount = 25 },
	{ id = 48508, chance = 5743 },
	{ id = 3039, chance = 4282 },
	{ id = 48509, chance = 3375 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2500, chance = 15, type = COMBAT_HOLYDAMAGE, minDamage = -400, maxDamage = -650, radius = 4, effect = CONST_ME_HOLYAREA, target = false },
	{ name = "combat", interval = 3000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -500, maxDamage = -650, length = 5, spread = 3, effect = CONST_ME_ENERGYHIT, target = false },
}
