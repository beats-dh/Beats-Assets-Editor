...
monster.loot = {
	{ id = 19083, chance = 140 }, -- silver raid token
	{ id = 19356, chance = 140 }, -- triple bolt crossbow
	{ id = 3369, chance = 1400 }, -- warrior helmet
	{ id = 19357, chance = 350 }, -- shrunken head necklace
	{ id = 3079, chance = 700 }, -- boots of haste
	{ id = 3436, chance = 1400 }, -- medusa shield
	{ id = 3284, chance = 1400 }, -- ice rapier
	{ id = 3029, chance = 14000, maxCount = 2 }, -- small sapphire
	{ id = 3370, chance = 2100 }, -- knight armor
	{ id = 236, chance = 14000, maxCount = 2 }, -- strong health potion
	{ id = 9302, chance = 700 }, -- sacred tree amulet
	{ id = 3081, chance = 14000 }, -- stone skin amulet
	{ id = 9058, chance = 560 }, -- gold ingot
	{ id = 3392, chance = 350 }, -- royal helmet
	{ id = 281, chance = 420 }, -- giant shimmering pearl (green)
	{ id = 4839, chance = 1400 }, -- hydra egg
	{ id = 237, chance = 14000, maxCount = 2 }, -- strong mana potion
	{ id = 3035, chance = 14000, maxCount = 10 }, -- platinum coin
	{ id = 3031, chance = 14000, maxCount = 100 }, -- gold coin
