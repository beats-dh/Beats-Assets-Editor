...
monster.loot = {
	...
	{ name = "werepanther claw", chance = 11056, maxCount = 2 },
	{ name = "golden sickle", chance = 5376 },
	{ name = "meat", chance = 4400, maxCount = 2 },
	{ name = "small ruby", chance = 6776, maxCount = 3 },
	{ name = "moonlight crystals", chance = 2040 },
	{ id = 3039, chance = 992 }, -- red gem
	{ name = "magma monocle", chance = 2464 },
	{ name = "ripper lance", chance = 680 },
	{ name = "gemmed figurine", chance = 1416 },
	{ id = 817, chance = 2216 }, -- magma amulet
	{ name = "fur armor", chance = 2096 },
	{ id = 43917, chance = 520 }, -- werepanther trophy
}
