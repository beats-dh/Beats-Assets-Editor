...
monster.loot = {
	...
	{ name = "serpent sword", chance = 4728 },
	{ name = "crocodile boots", chance = 6824 },
	{ name = "meat", chance = 4400, maxCount = 4 },
	{ name = "small topaz", chance = 7296, maxCount = 4 },
	...
	{ name = "glorious axe", chance = 1752 },
	{ name = "golden sun coin", chance = 1416 },
