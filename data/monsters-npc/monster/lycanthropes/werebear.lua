...
monster.loot = {
	...
	{ id = 239, chance = 960, maxCount = 2 }, -- great health potion
	{ id = 7643, chance = 1768 }, -- ultimate health potion
	{ id = 238, chance = 960 }, -- great mana potion
	{ id = 5896, chance = 640 }, -- bear paw
	{ id = 3582, chance = 1520, maxCount = 2 }, -- ham
	{ id = 5902, chance = 360 }, -- honeycomb
	{ id = 22057, chance = 464 }, -- werebear fur
	{ id = 7439, chance = 640 }, -- berserk potion
	{ id = 22056, chance = 448 }, -- werebear skull
	{ id = 3081, chance = 344 }, -- stone skin amulet
	{ id = 7419, chance = 96 }, -- dreaded cleaver
	{ id = 22085, chance = 240 }, -- fur armor
	{ id = 7432, chance = 320 }, -- furry club
	{ id = 22060, chance = 80 }, -- werewolf amulet
	{ id = 7383, chance = 160 }, -- relic sword
	{ id = 7452, chance = 240 }, -- spiked squelcher
	{ id = 3053, chance = 320 }, -- time ring
	{ id = 22103, chance = 160 }, -- werebear trophy
	{ id = 22083, chance = 160 }, -- moonlight crystals
}
