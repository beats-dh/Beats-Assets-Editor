...
monster.loot = {
	...
	{ name = "werepanther claw", chance = 10224 },
	{ name = "golden sickle", chance = 4096 },
	{ name = "meat", chance = 4400, maxCount = 2 },
	{ name = "small topaz", chance = 5696, maxCount = 4 },
	{ name = "moonlight crystals", chance = 2040 },
	{ id = 3037, chance = 4104 }, -- yellow gem
	{ name = "lightning headband", chance = 5760 },
	{ name = "ripper lance", chance = 680 },
	{ name = "gemmed figurine", chance = 1416 },
	{ id = 816, chance = 3768 }, -- lightning pendant
	{ name = "fur armor", chance = 2096 },
	{ id = 43917, chance = 480 }, -- werepanther trophy
}
