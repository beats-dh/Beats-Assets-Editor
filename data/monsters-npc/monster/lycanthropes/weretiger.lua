...
monster.loot = {
	...
	{ name = "weretiger tooth", chance = 8640 },
	{ name = "furry club", chance = 4984 },
	{ name = "meat", chance = 4400, maxCount = 4 },
	{ name = "violet crystal shard", chance = 2696 },
	{ name = "moonlight crystals", chance = 2040 },
	{ id = 3041, chance = 960 }, -- blue gem
	{ name = "knight armor", chance = 2400 },
	{ name = "angelic axe", chance = 1144 },
	{ name = "gemmed figurine", chance = 1416 },
	{ id = 817, chance = 1416 }, -- magma amulet
	{ name = "silver moon coin", chance = 408 },
