...
monster.loot = {
	...
	{ name = "gold coin", chance = 80000, maxCount = 60 },
	{ name = "small enchanted sapphire", chance = 4000, maxCount = 2 },
	{ name = "black pearl", chance = 4000, maxCount = 2 },
	{ name = "ham", chance = 4000, maxCount = 2 },
	{ name = "meat", chance = 4000, maxCount = 2 },
	{ name = "soul orb", chance = 4000, maxCount = 2 },
	{ name = "white pearl", chance = 1200, maxCount = 2 },
	{ name = "ankh", chance = 4000 },
	{ name = "crystal sword", chance = 4000 },
	{ name = "serpent sword", chance = 4000 },
	{ name = "rapier", chance = 4000 },
	{ name = "lion's mane", chance = 4000 },
	{ name = "lightning headband", chance = 1200 },
	{ name = "steel helmet", chance = 1200 },
	{ name = "doublet", chance = 1200 },
	{ name = "ivory carving", chance = 1200 },
	{ name = "magma legs", chance = 400 },
	{ name = "crown helmet", chance = 400 },
	{ name = "white silk flower", chance = 160 },
	{ name = "lion figurine", chance = 80 },
}
