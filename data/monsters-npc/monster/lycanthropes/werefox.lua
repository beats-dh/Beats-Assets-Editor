...
monster.loot = {
	...
	{ name = "platinum coin", chance = 3240, maxCount = 2 },
	{ name = "fox paw", chance = 3240, maxCount = 2 },
	{ name = "werefox tail", chance = 3240, maxCount = 2 },
	{ name = "strong mana potion", chance = 3240, maxCount = 2 },
	{ name = "great mana potion", chance = 3240, maxCount = 2 },
	{ name = "mana potion", chance = 3240, maxCount = 2 },
	{ name = "small enchanted emerald", chance = 3240, maxCount = 2 },
	{ name = "emerald bangle", chance = 3240, maxCount = 2 },
	{ name = "moonlight rod", chance = 400 },
	{ name = "troll green", chance = 400, maxCount = 2 },
	{ name = "assassin star", chance = 240, maxCount = 5 },
	{ name = "platinum amulet", chance = 104 },
	{ id = 3098, chance = 160 }, -- ring of healing
	{ name = "werewolf amulet", chance = 40 },
	{ id = 27706, chance = 24 }, -- werefox trophy
}
