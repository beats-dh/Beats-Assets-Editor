...
monster.loot = {
	...
	{ name = "tiger eye", chance = 5528 },
	{ name = "strong mana potion", chance = 5088, maxCount = 2 },
	{ name = "small sapphire", chance = 4648, maxCount = 3 },
	{ name = "spellbook of enlightenment", chance = 1536 },
	{ name = "opal", chance = 1480 },
	{ name = "gold-brocaded cloth", chance = 1424 },
	{ name = "gold ingot", chance = 768 },
	{ name = "broken iks headpiece", chance = 56 },
