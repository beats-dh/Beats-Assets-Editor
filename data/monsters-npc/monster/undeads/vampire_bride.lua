...
monster.loot = {
	{ name = "emerald bangle", chance = 880 },
	{ name = "small diamond", chance = 816, maxCount = 2 },
	{ name = "gold coin", chance = 72000, maxCount = 149 },
	{ name = "platinum coin", chance = 7928 },
	{ name = "moonlight rod", chance = 4400 },
	{ name = "boots of haste", chance = 176 },
	{ name = "strong health potion", chance = 4000 },
	{ name = "strong mana potion", chance = 8168 },
	{ id = 649, chance = 160 }, -- flower bouquet
	{ name = "hibiscus dress", chance = 824 },
	{ name = "blood goblet", chance = 48 },
	{ id = 8895, chance = 808 }, -- rusted armor
	{ id = 8923, chance = 776 }, -- velvet tapestry
	{ name = "vampire teeth", chance = 8000 },
	{ name = "blood preservation", chance = 3960 },
	{ name = "leather whip", chance = 16 },
}
