...
monster.loot = {
	{ id = 2949, chance = 7696 }, -- lyre
	{ name = "silver brooch", chance = 680 },
	{ name = "silver brooch", chance = 88 },
	{ id = 3019, chance = 88 }, -- demonbone amulet
	{ name = "gold coin", chance = 26400, maxCount = 100 },
	{ name = "gold coin", chance = 26400, maxCount = 100 },
	{ name = "gold coin", chance = 26400, maxCount = 97 },
	{ name = "platinum coin", chance = 3080, maxCount = 7 },
	{ id = 3049, chance = 152 }, -- stealth ring
	{ name = "wand of cosmic energy", chance = 7840 },
	{ name = "blank rune", chance = 24248, maxCount = 2 },
	{ name = "white piece of cloth", chance = 3040 },
	{ name = "soul orb", chance = 4804 },
	{ id = 6299, chance = 224 }, -- death ring
	{ name = "demonic essence", chance = 5016 },
	{ name = "relic sword", chance = 560 },
