...
monster.loot = {
	{ name = "platinum coin", chance = 72000, maxCount = 5 },
	{ name = "small diamond", chance = 38544, maxCount = 2 },
	{ name = "great spirit potion", chance = 32800, maxCount = 2 },
	{ name = "small emerald", chance = 37352, maxCount = 2 },
	{ name = "small amethyst", chance = 37800, maxCount = 3 },
	{ name = "assassin star", chance = 24104, maxCount = 10 },
	{ name = "small ruby", chance = 18904, maxCount = 2 },
	{ name = "small topaz", chance = 18768, maxCount = 2 },
	{ name = "onyx arrow", chance = 14752, maxCount = 15 },
	{ id = 3039, chance = 7072 }, -- red gem
	{ name = "green gem", chance = 4536 },
	{ name = "violet gem", chance = 4288 },
	{ id = 281, chance = 1608 }, -- giant shimmering pearl (green)
	{ name = "damaged armor plates", chance = 952 },
	{ name = "falcon crest", chance = 808 },
	{ name = "golden armor", chance = 336 },
	{ name = "mastermind shield", chance = 328 },
}
