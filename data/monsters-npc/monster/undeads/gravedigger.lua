...
monster.loot = {
	{ name = "gold coin", chance = 80000, maxCount = 137 },
	{ name = "platinum coin", chance = 19576 },
	{ name = "yellow gem", chance = 640 },
	{ name = "wand of inferno", chance = 4472 },
	{ name = "sudden death rune", chance = 5840 },
	{ name = "skull staff", chance = 104 },
	{ name = "mysterious voodoo skull", chance = 80 },
	{ id = 6299, chance = 640 }, -- death ring
	{ name = "strong health potion", chance = 1808, maxCount = 2 },
	{ name = "strong mana potion", chance = 2880, maxCount = 2 },
	{ name = "unholy bone", chance = 7656 },
	{ name = "pile of grave earth", chance = 5320 },
	{ name = "safety pin", chance = 4800 },
}
