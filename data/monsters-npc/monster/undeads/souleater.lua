...
monster.loot = {
	{ name = "gold coin", chance = 26720, maxCount = 100 },
	{ name = "gold coin", chance = 26720, maxCount = 100 },
	{ name = "platinum coin", chance = 39688, maxCount = 6 },
	{ name = "necrotic rod", chance = 784 },
	{ name = "wand of cosmic energy", chance = 728 },
	{ id = 5884, chance = 112 }, -- spirit container
	{ id = 6299, chance = 240 }, -- death ring
	{ name = "great mana potion", chance = 6400 },
	{ name = "ultimate health potion", chance = 7520 },
	{ name = "souleater trophy", chance = 16 },
	{ name = "lizard essence", chance = 12200 },
	{ name = "ectoplasmic sushi", chance = 1600 },
}
