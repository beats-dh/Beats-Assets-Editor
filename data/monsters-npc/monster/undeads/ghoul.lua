...
monster.loot = {
	{ id = 2920, chance = 4000 }, -- torch
	{ name = "gold coin", chance = 54400, maxCount = 30 },
	{ id = 3052, chance = 144 }, -- life ring
	{ id = 3114, chance = 192 }, -- skull
	{ name = "viking helmet", chance = 792 },
	{ name = "scale armor", chance = 800 },
	{ name = "worm", chance = 7680, maxCount = 2 },
	{ name = "brown piece of cloth", chance = 800 },
	{ name = "rotten piece of cloth", chance = 11576 },
	{ name = "ghoul snack", chance = 4104 },
	{ name = "pile of grave earth", chance = 760 },
	{ id = 23986, chance = 800 }, -- heavy old tome
}
