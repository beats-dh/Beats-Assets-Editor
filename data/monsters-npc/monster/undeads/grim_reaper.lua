...
monster.loot = {
	{ name = "gold coin", chance = 79200, maxCount = 263 },
	{ name = "platinum coin", chance = 4160, maxCount = 4 },
	{ id = 3046, chance = 3880 }, -- magic light wand
	{ name = "dark shield", chance = 2400 },
	{ name = "scythe", chance = 7200 },
	{ name = "orichalcum pearl", chance = 1120, maxCount = 4 },
	{ id = 6299, chance = 264 }, -- death ring
	{ name = "demonic essence", chance = 8480 },
	{ name = "flask of demonic blood", chance = 28000 },
	{ name = "nightmare blade", chance = 704 },
	{ name = "great mana potion", chance = 8000 },
	{ name = "glacier kilt", chance = 264 },
	{ name = "ultimate health potion", chance = 7680 },
	{ name = "skullcracker armor", chance = 216 },
	{ name = "underworld rod", chance = 728 },
	{ id = 8896, chance = 2000 }, -- slightly rusted armor
	{ name = "mystical hourglass", chance = 4240 },
}
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_DEATHDAMAGE, minDamage = -350, maxDamage = -720, length = 8, spread = 0, effect = CONST_ME_MORTAREA, target = false },
	...
	{ name = "grim_reaper_blood_rage", interval = 3000, chance = 25 },
}
