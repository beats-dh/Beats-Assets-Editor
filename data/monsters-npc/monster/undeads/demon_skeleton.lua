...
monster.loot = {
	{ id = 2920, chance = 4216 }, -- torch
	{ name = "black pearl", chance = 2320 },
	{ name = "small ruby", chance = 1120 },
	{ name = "gold coin", chance = 77600, maxCount = 75 },
	{ name = "mind stone", chance = 416 },
	{ name = "mysterious fetish", chance = 552 },
	{ name = "throwing star", chance = 8000, maxCount = 3 },
	{ name = "battle hammer", chance = 3200 },
	{ name = "iron helmet", chance = 2760 },
	{ name = "battle shield", chance = 4000 },
	{ name = "guardian shield", chance = 80 },
	{ name = "health potion", chance = 8096, maxCount = 2 },
	{ name = "health potion", chance = 8000, maxCount = 2 },
	{ name = "mana potion", chance = 4240 },
	{ name = "demonic skeletal hand", chance = 10080 },
	{ name = "stone skin amulet", chance = 80 }
}
