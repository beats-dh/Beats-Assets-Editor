...
monster.loot = {
	{ id = 2817, chance = 728 }, -- blank parchment
	{ name = "gold coin", chance = 38400, maxCount = 67 },
	{ id = 3049, chance = 520 }, -- stealth ring
	{ name = "spike sword", chance = 104 },
	{ name = "red robe", chance = 104 },
	{ name = "tattered piece of robe", chance = 3440 },
}
