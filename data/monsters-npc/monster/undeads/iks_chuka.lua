...
monster.loot = {
	...
	{ name = "violet crystal shard", chance = 12696 },
	{ name = "green crystal splinter", chance = 9880 },
	{ name = "small sapphire", chance = 7952 },
	{ name = "royal spear", chance = 3168, maxCount = 1 },
	{ id = 3007, chance = 1408 }, -- crystal ring
	{ name = "rotten feather", chance = 1368 },
	{ name = "ritual tooth", chance = 1072 },
	{ name = "gold-brocaded cloth", chance = 768 },
	{ name = "broken iks spear", chance = 88 },
	{ name = "broken iks headpiece", chance = 40 },
}
