...
monster.loot = {
	{ name = "white pearl", chance = 2400 },
	{ name = "gold coin", chance = 56000, maxCount = 144 },
	{ name = "scarab coin", chance = 8000, maxCount = 3 },
	{ id = 3059, chance = 5440 }, -- spellbook
	{ id = 3098, chance = 800 }, -- ring of healing
	{ name = "orichalcum pearl", chance = 4800, maxCount = 4 },
	{ name = "health potion", chance = 12000 },
	{ name = "mana potion", chance = 12000 },
	{ id = 12482, chance = 21600 }, -- hieroglyph banner
}
