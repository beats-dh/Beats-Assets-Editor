...
monster.loot = {
	{ name = "platinum coin", chance = 35200, maxCount = 40 },
	{ name = "belted cape", chance = 400 },
	{ name = "ultimate health potion", chance = 400, maxCount = 2 },
	{ name = "throwing star", chance = 400, maxCount = 18 },
	{ name = "knight axe", chance = 200 },
	{ id = 3307, chance = 400 }, -- scimitar
	{ name = "protection amulet", chance = 200 },
	{ name = "hunting spear", chance = 200 },
	{ name = "broken gladiator shield", chance = 200 },
	{ name = "dark helmet", chance = 200 },
	{ name = "flask of warrior's sweat", chance = 200 },
	{ name = "plate armor", chance = 200 },
	{ name = "plate legs", chance = 200 },
	{ name = "two handed sword", chance = 200 },
	{ name = "great health potion", chance = 200, maxCount = 2 },
	{ id = 3049, chance = 184 }, -- stealth ring
	{ name = "crusader helmet", chance = 120 },
	{ name = "relic sword", chance = 120 },
}
