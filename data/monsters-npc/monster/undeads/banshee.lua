...
monster.loot = {
	{ name = "candlestick", chance = 56000 },
	{ name = "wedding ring", chance = 368 },
	{ id = 3007, chance = 48 }, -- crystal ring
	{ name = "silver brooch", chance = 1000 },
	{ name = "white pearl", chance = 808 },
	{ name = "black pearl", chance = 1624 },
	{ name = "gold coin", chance = 24000, maxCount = 80 },
	{ name = "silver amulet", chance = 6960 },
	{ id = 3059, chance = 416 }, -- spellbook
	{ name = "life crystal", chance = 56 },
	{ name = "stone skin amulet", chance = 656 },
	{ id = 3098, chance = 584 }, -- ring of healing
	{ id = 2949, chance = 728 }, -- lyre
	{ name = "poison dagger", chance = 1080 },
	{ name = "red robe", chance = 120 },
	{ name = "blue robe", chance = 560 },
	{ name = "simple dress", chance = 4840 },
	{ name = "strong mana potion", chance = 544 },
	{ name = "terra mantle", chance = 272 },
	{ name = "petrified scream", chance = 3320 },
	{ name = "hair of a banshee", chance = 3848 },
	{ name = "sweet smelling bait", chance = 32 },
}
