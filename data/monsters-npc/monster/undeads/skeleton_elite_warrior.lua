...
monster.loot = {
	{ name = "platinum coin", chance = 34800, maxCount = 15 },
	{ id = 3115, chance = 40000 }, -- bone
	{ name = "white mushroom", chance = 19200, maxCount = 3 },
	{ name = "soul orb", chance = 34800, maxCount = 5 },
	{ name = "knight axe", chance = 2600 },
	{ name = "pelvis bone", chance = 2104, maxCount = 10 },
	{ name = "unholy bone", chance = 2104, maxCount = 5 },
	{ name = "skull helmet", chance = 280 },
	{ name = "ruthless axe", chance = 120 },
}
