...
monster.loot = {
	...
	{ name = "flash arrow", chance = 14160, maxCount = 10 },
	{ name = "great spirit potion", chance = 12152, maxCount = 2 },
	{ name = "spectral silver nugget", chance = 9216 },
	{ name = "spectral gold nugget", chance = 4544 },
	{ name = "emerald bangle", chance = 1072 },
	{ name = "lightning boots", chance = 1072 },
	{ name = "diamond", chance = 800 },
	{ name = "lightning robe", chance = 800 },
	{ name = "elven amulet", chance = 800 },
	{ name = "lightning legs", chance = 664 },
