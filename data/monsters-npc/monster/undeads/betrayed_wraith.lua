...
monster.loot = {
	{ name = "small diamond", chance = 9440, maxCount = 4 },
	{ name = "gold coin", chance = 80000, maxCount = 200 },
	{ name = "platinum coin", chance = 80000, maxCount = 8 },
	{ name = "power bolt", chance = 40000, maxCount = 5 },
	{ name = "orichalcum pearl", chance = 6400, maxCount = 2 },
	{ name = "skull helmet", chance = 312 },
	{ name = "golden figurine", chance = 128 },
	{ name = "soul orb", chance = 8000 },
	{ id = 6299, chance = 312 }, -- death ring
	{ name = "demonic essence", chance = 15544 },
	{ name = "flask of demonic blood", chance = 52200 },
	{ name = "assassin star", chance = 8624, maxCount = 5 },
	{ name = "mercenary sword", chance = 1512 },
	{ name = "bloody edge", chance = 64 },
	{ name = "great mana potion", chance = 12000, maxCount = 3 },
	{ name = "ultimate health potion", chance = 12328 },
	{ name = "unholy bone", chance = 14728 },
}
