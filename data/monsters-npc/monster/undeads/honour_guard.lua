...
monster.loot = {
	{ name = "gold coin", chance = 40000, maxCount = 15 },
	{ name = "scarab coin", chance = 2080 },
	{ name = "mace", chance = 3008 },
	{ id = 3307, chance = 1312 }, -- scimitar
	{ name = "brown mushroom", chance = 4896, maxCount = 2 },
	{ name = "pelvis bone", chance = 6960 },
}
