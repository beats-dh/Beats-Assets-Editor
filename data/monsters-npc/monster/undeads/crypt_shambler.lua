...
monster.loot = {
	{ name = "small diamond", chance = 408 },
	{ name = "gold coin", chance = 45600, maxCount = 55 },
	{ name = "rotten meat", chance = 1480 },
	{ id = 3115, chance = 4000 }, -- bone
	{ name = "throwing star", chance = 728, maxCount = 3 },
	{ name = "bone sword", chance = 800 },
	{ name = "iron helmet", chance = 1704 },
	{ name = "iron helmet", chance = 1600 },
	{ name = "bone shield", chance = 800 },
	{ name = "worm", chance = 7200, maxCount = 10 },
	{ name = "half-digested piece of meat", chance = 4000 },
}
