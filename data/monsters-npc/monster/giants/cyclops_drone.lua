...
monster.loot = {
	{ name = "gold coin", chance = 65600, maxCount = 30 },
	{ id = 3093, chance = 72 }, -- club ring
	{ name = "halberd", chance = 544 },
	{ name = "short sword", chance = 6400 },
	{ name = "dark helmet", chance = 152 },
	{ name = "plate shield", chance = 1600 },
	{ name = "battle shield", chance = 1280 },
	{ name = "meat", chance = 40344, maxCount = 2 },
	{ id = 7398, chance = 96 }, -- cyclops trophy
	{ name = "strong health potion", chance = 416 },
	{ name = "cyclops toe", chance = 5400 },
}
