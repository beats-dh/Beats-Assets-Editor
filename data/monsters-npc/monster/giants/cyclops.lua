...
monster.loot = {
	{ id = 3012, chance = 152 }, -- wolf tooth chain
	{ name = "gold coin", chance = 65600, maxCount = 47 },
	{ id = 3093, chance = 72 }, -- club ring
	{ name = "halberd", chance = 802 },
	{ name = "short sword", chance = 6400 },
	{ name = "dark helmet", chance = 176 },
	{ name = "plate shield", chance = 2000 },
	{ name = "battle shield", chance = 1120 },
	{ name = "meat", chance = 24056 },
	{ id = 7398, chance = 64 }, -- cyclops trophy
	{ name = "health potion", chance = 168 },
	{ name = "cyclops toe", chance = 3944 },
