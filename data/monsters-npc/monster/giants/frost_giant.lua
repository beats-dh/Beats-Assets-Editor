...
monster.loot = {
	{ name = "gold coin", chance = 65600, maxCount = 40 },
	{ id = 3093, chance = 104 }, -- club ring
	{ name = "halberd", chance = 448 },
	{ name = "short sword", chance = 6512 },
	{ name = "dark helmet", chance = 144 },
	{ name = "battle shield", chance = 1080 },
	{ name = "meat", chance = 3976, maxCount = 2 },
	{ name = "shard", chance = 48 },
	{ id = 7441, chance = 1744 }, -- ice cube
	{ name = "norse shield", chance = 200 },
	{ name = "health potion", chance = 655 },
	{ name = "frost giant pelt", chance = 4000 },
}
