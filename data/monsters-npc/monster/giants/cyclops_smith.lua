...
monster.loot = {
	{ name = "gold coin", chance = 66336, maxCount = 70 },
	{ id = 3093, chance = 72 }, -- club ring
	{ name = "battle axe", chance = 4360 },
	{ name = "double axe", chance = 704 },
	{ name = "battle hammer", chance = 4160 },
	{ name = "heavy machete", chance = 1600 },
	{ name = "dark helmet", chance = 160 },
	{ name = "plate shield", chance = 1600 },
	{ name = "battle shield", chance = 4952 },
	{ name = "meat", chance = 39960 },
	{ id = 7398, chance = 112 }, -- cyclops trophy
	{ name = "spiked squelcher", chance = 120 },
	{ name = "strong health potion", chance = 312 },
	{ name = "cyclops toe", chance = 8224 },
}
