...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "kneel") then
		local kv = player:kv():scoped("rotten-blood-quest"):get("firstReward") or 0
		if kv < 1 then
			npcHandler:say("Your soul is unworthy to prostrate before my ancient essence. The dark powers reject your presence.", npc, creature)
