...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "mission") then
		...
		if npcHandler:getTopic(playerId) <= 5 and mission == 1 then
			...
			npcHandler:setTopic(playerId, 6)
		elseif mission == 1 and player:getStorageValue(Storage.Quest.U13_30.TwentyYearsACook.Missions.Mission01) == 1 then
		...
		elseif mission == 3 and player:getStorageValue(Storage.Quest.U13_30.TwentyYearsACook.Missions.Mission01) == 2 then
		...
		elseif mission == 5 and player:getStorageValue(Storage.Quest.U13_30.TwentyYearsACook.Missions.Mission02) == 2 then
		...
		elseif mission == 7 and player:getStorageValue(Storage.Quest.U13_30.TwentyYearsACook.Missions.Mission03) == 3 then
		...
		elseif mission == 9 and player:getStorageValue(Storage.Quest.U13_30.TwentyYearsACook.Missions.Mission04) == 4 then
