...
local function creatureSayCallback(npc, creature, type, message)
	...
	hasQuestLine = player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.QuestLine) > 0
	hasAtLeastOneShrine = player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.DawnportFirstShrine) > 0 or player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.DawnportSecondShrine) > 0 or player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.DawnportThirdShrine) > 0 or player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.DawnportFourthShrine) > 0
	...
	elseif MsgContains(message, "yes") and player:getVocation():getBaseId() == VOCATION.BASE_ID.MONK then
		if npcHandler:getTopic(playerId) == 1 and player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.QuestLine) < 1 then
			...
			player:setStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.QuestLine, 0)
			player:setStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.Missions.TreeFoldPath, 1)
			player:setStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.DawnportFirstShrine, 0)
			player:setStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.DawnportSecondShrine, 0)
			player:setStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.DawnportThirdShrine, 0)
			player:setStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.DawnportFourthShrine, 0)
		elseif npcHandler:getTopic(playerId) == 2 then
			...
			player:setStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.Missions.TreeFoldPath, 2)
			player:setStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.QuestLine, 0)
			player:setStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.ShrinesCount, 1)
			npcHandler:setTopic(playerId, 0)
